...
1. Test for Validity (Internal Consistency): Assume for a moment that all of the author's evidence is 100% true. If the evidence is true, _must_ the conclusion also be true? If the conclusion could still be false even if the premises are true, the argument is logically invalid.
