...
GitHub: [BabyAGI](https://github.com/yoheinakajima/babyagi)
...
GitHub: [SuperAGI](https://github.com/TransformerOptimus/SuperAGI)
...
GitHub: [Open Agents](https://github.com/All-Hands-AI/OpenHands)
...
For those looking to deepen their practical skills and gain hands-on experience with AI agent frameworks and LLM orchestration, consider enrolling in the [ODSC 5-Week Spring AI Bootcamp](https://app.aiplus.training/courses/odsc-2025-5-week-spring-ai-bootcamp). This immersive course offers real-world projects, industry insights, and mentorship to help you transition from foundational knowledge to applied AI engineering.

Sign up now and join the bootcamp here today: [https://app.aiplus.training/courses/odsc-2025-5-week-spring-ai-bootcamp](https://app.aiplus.training/courses/odsc-2025-5-week-spring-ai-bootcamp)
