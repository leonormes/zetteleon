...
captured: 2026-07-27T17:03:36+01:00 2026-07-27T17:03:36+01:00
status: processing
tags:
- input
type: head
permalink: llmeon/20-thinking/21-workbench/head-mcps-biggest-update-removes-the-machinery-many-servers-were-built-around
---

## Raw Output / Content
MCP's biggest revision removes sessions and the initialization handshake, shifts state into handles, and makes remote servers act more like stateless HTTP.

![Featued image for: MCP’s biggest update removes the machinery many servers were built around](https://cdn.thenewstack.io/media/2026/07/9ecb805c-getty-images-183ra32ukdi-unsplash-1024x683.jpg)
