...
Lamport views computer science as an extension of mathematics. He argues that an algorithm without a formal proof of correctness is merely a conjecture, not a theorem \[

[00:43](http://www.youtube.com/watch?v=rkZzg7Vowao&t=43)
...
### Distributed Systems and Special Relativity

One of Lamport's most significant contributions is his work on distributed systems. He famously defines a distributed system as one where your own computer can become useless because of the failure of a machine you didn't even know existed \[

[02:50](http://www.youtube.com/watch?v=rkZzg7Vowao&t=170)
...
The algorithm is unique because it makes very few assumptions about the hardware. It works even if the system's memory is "unreliable" during a read or write—meaning that if one process reads a number while another is changing it, the algorithm still maintains correctness \[

[07:03](http://www.youtube.com/watch?v=rkZzg7Vowao&t=423)

\]. This robustness is a point of pride for Lamport because it was a property he discovered through mathematical proof rather than intentional design \[

[07:12](http://www.youtube.com/watch?v=rkZzg7Vowao&t=432)

\].

### Research Philosophy

Throughout his career, Lamport has preferred finding problems in the "real world" of industry rather than in purely theoretical contemplation. He compares his research to a painter working outdoors; just as nature provides a far greater variety of leaves to paint than one could imagine in a studio, the challenges faced by engineers provide a endless supply of complex problems to solve \[

[05:35](http://www.youtube.com/watch?v=rkZzg7Vowao&t=335)

\].

[https://www.youtube.com/watch?v=rkZzg7Vowao](https://www.youtube.com/watch?v=rkZzg7Vowao)[Quanta Magazine · 3.5m views](http://www.youtube.com/watch?v=rkZzg7Vowao)
