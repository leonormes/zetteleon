...
- **Depth over brevity**: Explain the *why* and the *principle*, not just the *how*.
...
- **Atomic notes**: Use declarative, full-sentence titles that capture the core insight (e.g., *"A Goals-First Mentality Restricts Happiness"*).
- **Frontmatter fields**: `title`, `type`, `created`, `modified`, `tags`, `status`, `aliases`. Use ISO 8601 timestamps.
