...
tags: [articles]
title: hashicorpterraform-mcp-server The Terraform MCP Server provides seamless integration with Terraform ecosystem, enabling advanced automation and interaction capabilities for Infrastructure as Code (IaC) development.
---

## hashicorp/terraform-mcp-server: The Terraform MCP Server Provides Seamless Integration with Terraform Ecosystem, Enabling Advanced Automation and Interaction Capabilities for Infrastructure as Code (IaC) Development

![rw-book-cover](https://opengraph.githubassets.com/f6aa88a261fe2fb4c6b21206fc46e44591c3bbc170cc7d4114bd8c85fea6c36e/hashicorp/terraform-mcp-server)

### Metadata

- Author: [[https://github.com/hashicorp/]]
- Full Title: hashicorp/terraform-mcp-server: The Terraform MCP Server provides seamless integration with Terraform ecosystem, enabling advanced automation and interaction capabilities for Infrastructure as Code (IaC) development.
- Category: articles
- Summary: The Terraform MCP Server integrates with the Terraform ecosystem to help automate Infrastructure as Code development. It supports multiple communication methods and works easily with Docker for deployment. Users can search providers, modules, and policies directly from the Terraform Registry through this server.
...
[Open in github.dev](https://github.dev/) [Open in a new github.dev tab](https://github.dev/) [Open in codespace](https://github.com/codespaces/new/hashicorp/terraform-mcp-server?resume=1)
...
The Terraform MCP Server is a [Model Context Protocol (MCP)](https://modelcontextprotocol.io/introduction) server that provides seamless integration with Terraform Registry APIs, enabling advanced automation and interaction capabilities for Infrastructure as Code (IaC) development.
...
- Go (check [go.mod](https://github.com/hashicorp/terraform-mcp-server/blob/main/go.mod) file for specific version)
...
This project is licensed under the terms of the MPL-2.0 open source license. Please refer to [LICENSE](https://github.com/hashicorp/terraform-mcp-server/blob/main/LICENSE) file for the full terms.

#### Security

For security issues, please contact [security@hashicorp.com](mailto:security@hashicorp.com) or follow our [security policy](https://www.hashicorp.com/en/trust/security/vulnerability-management).
