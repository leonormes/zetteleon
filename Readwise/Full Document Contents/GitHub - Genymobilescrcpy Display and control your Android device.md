...
This application mirrors Android devices (video and audio) connected via USB or [TCP/IP](https://github.com/Genymobile/scrcpy/blob/master/doc/connection.md#tcpip-wireless) and allows control using the computer's keyboard and mouse. It does not require *root* access or an app installed on the device. It works on *Linux*, *Windows*, and *macOS*.
...
I'm [@rom1v](https://github.com/rom1v), the author and maintainer of *scrcpy*.
