...
tags: [articles]
title: Implementing the Knowledge to Action (KTA) Model to Pick Change Strategies
---

## Implementing the Knowledge to Action (KTA) Model to Pick Change Strategies

![rw-book-cover](http://static1.squarespace.com/static/62b608b9681f5f0b4f3c3659/631b918b0bec475598b75b62/63c18e6dcb96191aa237fc8f/1744992154210/Bulletin+-+Default+Social+Sharing.png?format=1500w)

### Metadata

- Author: [[The Center for Implementation]]
- Full Title: Implementing the Knowledge to Action (KTA) Model to Pick Change Strategies
- Category: articles
- Summary: Implementation is hard, and using a process model helps you choose strategies to change behavior. The Knowledge to Action (KTA) model starts with evidence, assesses barriers and facilitators, and guides selection of theoryand evidence-based implementation strategies. KTA can be used for clinical practices or internal organizational changes to plan and sustain change.
- URL: <https://thecenterforimplementation.com/toolbox/knowledge-to-action-model>
...
- An _evidence-based practice_ describes WHAT you want someone to do differently, hopefully clarifying WHO needs to change and WHAT changes they need to make.
- An _implementation strategy_ describes HOW a person/organization/system changes. It is about the strategies we use to change someone's behaviour.
- An _evidence-based program_ includes both the evidence-based practice and the implementation strategies. The combination of these has been systematically evaluated and shown to produce desired outcomes.

Before you pick a process model, you need to figure out if you are working with an evidence-based _practice_ or _program_. This is because some process models describe how to implement an evidence-based program, while others help you develop a program if you only have an evidence-based practice. If you're starting with an evidence-based practice, then you need to select implementation strategies before you start implementing–these will help you figure out _how_ you will support behaviour change.

#### Knowledge to Action

![](https://images.squarespace-cdn.com/content/v1/62b608b9681f5f0b4f3c3659/a3d1768a-a03f-4931-acaf-f12dce8c6e2e/kta+image.png?format=2500w)

The [knowledge to action (KTA)](https://www.ncbi.nlm.nih.gov/pubmed/16557505) is a process model that helps you select implementation strategies. One of the things that makes the KTA unique is that it begins with research evidence, the need to synthesize and translate that evidence–these are represented by the funnel in the middle of the cycle. This makes the KTA very well-suited to situations where you have a practice change you want to make–a clearly defined set of recommendations about how you want someone to do something differently, for example recommendations from an evidence-based guideline.
...
By [Louise Zitzelsberger](https://www.linkedin.com/in/louise-zitzelsberger-093bb615/) and Diana Kaan, Senior Policy Analysts, Knowledge Translation Team, Strategic Policy Branch, Health Canada
...
Our first task was to establish a theoretical foundation to ensure a common understanding of KT and its application. After adopting the definition of KT developed by [CIHR](http://www.cihr-irsc.gc.ca/e/29418.html), we turned our attention to choosing a model that could guide the newly-established KT initiative.

The Knowledge to Action (KTA) model ([Graham, ID., et al. 2006](https://www.ncbi.nlm.nih.gov/pubmed/16557505)) was chosen because it:

![](https://images.squarespace-cdn.com/content/v1/62b608b9681f5f0b4f3c3659/8eb22eb8-c782-4632-b432-b670f6ce8876/KT%2BPlanner%2BScreenshot.png?format=2500w)
...
These articles were featured in our monthly _Implementation in Action_ bulletin! Want to receive our next issue? [Subscribe here](http://thecenterforimplementation.com/newsletter).

- [Do barriers and facilitators assessments have to be resource-intensive?](https://thecenterforimplementation.com/toolbox/barriers-and-facilitators-assessments-resource-intensive)
- [StrategEase tool](https://thecenterforimplementation.com/strategease-tool)
