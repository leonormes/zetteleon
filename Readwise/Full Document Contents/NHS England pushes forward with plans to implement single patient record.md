...
tags: [articles]
title: NHS England pushes forward with plans to implement single patient record
---

## NHS England Pushes forward with Plans to Implement Single Patient Record

![rw-book-cover](https://s3-eu-west-2.amazonaws.com/images.pulsetoday.co.uk/wp-media-folder-pulse-today/wp-content/uploads/2025/10/Single-patient-record-in-test-phase-says-NHS-England.jpg)

### Metadata

- Author: [[Harry Hetherington]]
- Full Title: NHS England pushes forward with plans to implement single patient record
- Category: articles
- Summary: NHS England is testing plans for a single patient record (SPR) to give patients and clinicians a unified, up-to-date view of health data across care settings.
Three technical models are being trialled and a prototype is expected for review by year-end, with patient access via the NHS App planned from 2028.
Clinicians and groups warn about data security and access concerns, and new law will be needed to require providers to share patient records.
- URL: <https://www.pulsetoday.co.uk/news/technology/nhs-england-pushes-forward-with-plans-to-implement-single-patient-record/>

### Full Document

![NHS England pushes forward with plans to implement single patient record](https://s3-eu-west-2.amazonaws.com/images.pulsetoday.co.uk/wp-media-folder-pulse-today/wp-content/uploads/2025/10/Single-patient-record-in-test-phase-says-NHS-England.jpg)Getty

NHS England is pushing forward with plans to implement a single patient record, and is currently testing different models, it has announced.
...
Plans for the SPR were [trailed by health secretary Wes Streeting last October](https://www.pulsetoday.co.uk/news/technology/streeting-pushes-single-patient-record-plans-with-new-data-sharing-laws/) and formally announced this year as part of the NHS [10-year health plan](https://www.pulsetoday.co.uk/category/special-investigations/10-year-health-plan/), which confirmed the [SPR would be available to patients via the NHS App by 2028](https://www.pulsetoday.co.uk/news/clinical-areas/cardiovascular/single-patient-record-to-become-available-via-nhs-app-by-2028/).
...
In an [NHS England meeting last month](https://www.england.nhs.uk/publication/video-of-the-nhs-england-board-meeting-23-september-2025/), Ming Tang, its chief data and analytics officer and interim chief digital and information officer, said a resultant SPR 'prototype' would likely be 'ready for review by the end of the year'.
...
Palantir–a data analytics company known for its work with US intelligence and security agencies–[was awarded a £330m, seven-year contract in 2023](https://www.pulsetoday.co.uk/news/technology/us-tech-giant-palantir-awarded-huge-nhs-data-sharing-contract/) to deliver the FDP.

Earlier this year, the BMA passed a motion at its annual representative meeting (ARM) [urging the NHS to cut ties with the company](https://www.pulsetoday.co.uk/news/technology/palantir-accuses-bma-of-choosing-ideology-over-patient-interest-amid-nhs-data-row/)–calling it 'an unacceptable choice of partner' to handle patient data.
