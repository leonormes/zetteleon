...
![rw-book-cover](https://cdn.terminaltrove.com/m/e87df025-96a6-4e09-9953-d8d627234df1.png)

## Metadata
- Author: [[terminaltrove.com]]
- Full Title: A CLI to manage emails.
- Category: #articles
- Summary: himalaya is a command-line email client that lets you manage email entirely from the terminal.  
It supports multiple accounts, IMAP/Maildir, OAuth2, SMTP sending, PGP, and system keyring storage.  
Ideal for hobbyists and power users who want a lightweight, scriptable terminal mail tool.
- URL: https://terminaltrove.com/himalaya/

## Full Document
![image preview of himalaya](https://cdn.terminaltrove.com/m/cb820338-d0dd-44bd-b666-f9f76b4863ef.gif)image preview of himalaya
