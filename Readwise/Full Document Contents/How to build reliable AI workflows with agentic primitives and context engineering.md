...
6. Build your first `.spec.md` template for feature specifications (you can use [spec-kit](https://github.com/github/spec-kit) for this).
7. Practice a spec-driven approach with session splitting: [plan](https://github.com/github/spec-kit?tab=readme-ov-file#4-create-a-technical-implementation-plan) first, split into [tasks](https://github.com/github/spec-kit?tab=readme-ov-file#5-break-down-into-tasks), and lastly, [implement](https://github.com/github/spec-kit?tab=readme-ov-file#6-execute-implementation).
