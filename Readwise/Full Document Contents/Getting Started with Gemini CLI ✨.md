...
There are _several_ poorly formatted pieces of the code that the `ruff` commands added to the GEMINI.md file should be able to fix (spacing, double quotes instead of single quotes, etc.).
