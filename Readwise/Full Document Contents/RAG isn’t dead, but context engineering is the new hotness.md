...
tags: [articles]
title: RAG isn’t dead, but context engineering is the new hotness
---

## RAG Isn't Dead, but Context Engineering is the New Hotness

![rw-book-cover](https://cdn.thenewstack.io/media/2026/01/f3a072ec-amin-zabardast-torash0awyk-unsplashc.jpg)

### Metadata

- Author: [[Richard MacManus]]
- Full Title: RAG isn't dead, but context engineering is the new hotness
- Category: articles
- Summary: RAG is not dead but now called "context engineering," which includes new tools like MCP. Contextual AI focuses on helping enterprises build smart agents that manage data and context securely. The future of AI development is about managing the full context, not just simple prompts.
- URL: <https://thenewstack.io/rag-isnt-dead-but-context-engineering-is-the-new-hotness/>

### Full Document

![Featued image for: RAG isn’t dead, but context engineering is the new hotness](https://cdn.thenewstack.io/media/2026/01/f3a072ec-amin-zabardast-torash0awyk-unsplashc-1024x576.jpg)Photo by Amin Zabardast on Unsplash.
...
"I think people have rebranded it now as _context engineering_, which includes MCP and RAG," he said. "I mean, the 'R' in RAG just stands for 'retrieval.' So, I think I said this last time too, if you're using MCP to do your retrieval, then it's basically RAG, right?"
...
[![Contextual AI platform](https://cdn.thenewstack.io/media/2026/01/b3be3b64-contextual-agent-composer.png)](https://cdn.thenewstack.io/media/2026/01/b3be3b64-contextual-agent-composer.png)Contextual AI platform; image via the company.
