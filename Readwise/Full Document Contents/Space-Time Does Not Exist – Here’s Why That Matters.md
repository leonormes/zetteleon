...
tags: [articles]
title: Space-Time Does Not Exist – Here’s Why That Matters
---

## Space-Time Does Not Exist–Here's Why That Matters

![rw-book-cover](https://scitechdaily.com/images/Spacetime-Special-Relativity-Concept.jpg)

### Metadata

- Author: [[Daryl Janzen]]
- Full Title: Space-Time Does Not Exist–Here's Why That Matters
- Category: articles
- Summary: Space-time is a tool we use to map when and where events happen, but it is not a real thing that exists. Events happen; they do not exist like objects or places. Understanding this helps clear up confusion about time and avoids misleading ideas like time travel.
- URL: <https://scitechdaily.com/space-time-does-not-exist-heres-why-that-matters/>

### Full Document

[![Spacetime Special Relativity Concept](https://scitechdaily.com/images/Spacetime-Special-Relativity-Concept.jpg)](https://scitechdaily.com/images/Spacetime-Special-Relativity-Concept.jpg)Space-time is often imagined as a real fabric in which past, present, and future events coexist—but this interpretation may be misleading. Credit: Stock

Space-time is a map of happenings, not a real object. Understanding this distinction clears up confusion about time.

Whether or not space-time exists should not be considered controversial or even conceptually difficult once we are clear on the meanings of "space-time," "events," and "instants." Believing in the existence of space-time is no more viable than [holding onto the old notion of a celestial sphere](https://www.space.com/geocentric-model): both are observer-centered models that are powerful and convenient for describing the world, but neither represents reality itself.

Still, from the perspectives of modern [physics](https://physicsgg.me/wp-content/uploads/2023/05/misner_thorne_wheeler_gravitation_freema.pdf), [philosophy](http://strangebeautiful.com/other-texts/dieks-redei-onto-st.pdf), [popular science communication](https://rcsstewa.com/wp-content/uploads/2020/12/The-Fabric-of-the-Cosmos-Space-Time-and-the-Texture-of-Reality-by-Brian-Greene-z-lib.org_.pdf), and even [science fiction](https://archive.org/details/wells-1922-time-machine/page/n1/mode/2up?view=theater), stating that space-time does not exist remains a provocative claim.
...
It is tempting to imagine past events—such as losing a tooth or hearing good news—as if they continue to exist elsewhere. Time travel stories [reinforce this idea](https://www.imdb.com/title/tt0088763/), portraying the past and future as destinations that can be accessed or altered with the right technology.

Philosophers often talk this way too. [Eternalism](https://iep.utm.edu/eternalism/) says all events across all time exist. The growing block view suggests the past and present exist while the future will come to be. [Presentism](https://plato.stanford.edu/entries/presentism/) says only the present exists, while the past used to exist and the future will when it happens. And [general relativity](https://www.quantamagazine.org/how-to-think-about-relativitys-concept-of-space-time-20221114/?utm_source=chatgpt.com) presents a four-dimensional continuum that bends and curves—we tend to imagine that continuum of the events as really existing.
...
[![Stencil Interpretation of René Magritte](https://scitechdaily.com/images/Stencil-Interpretation-of-Rene-Magritte-2048x1537.jpg)](https://scitechdaily.com/images/Stencil-Interpretation-of-Rene-Magritte.jpg)A stencil interpretation of René Magritte's 1929 painting, 'La Trahison des images,' in which the artist points out that the representation of an object is not the object itself. Credit: bixentro/Wikimedia Commons
...
Physicists describe a car traveling straight at constant speed with a simple [space-time diagram](https://www.desmos.com/calculator/0aiwplusxp): position on one axis, time on the other. Instants stack together to form a two-dimensional space-time. The car's position is a point within each instant, and those points join to form a worldline—the full record of the car's position throughout the time interval, whose slope is the car's speed.
...
Second, this recognition reframes the [philosophy of time](https://plato.stanford.edu/entries/time/). Much debate over the past century has treated events as [things that exist](https://plato.stanford.edu/entries/events/#EveMetSem). Philosophers then focus on their tense properties: is an event past, present, or future? Did this one occur earlier or later than that one?

These discussions rely on an assumption that events are existent things that bear these properties. From there, it's a short step to the conclusion that time is unreal or that the passage of time is an illusion, on the identification that the same event can be labeled differently from different standpoints. But [the ontological distinction was lost at the start](https://plato.stanford.edu/entries/mcTaggart/#UnrTim): events don't exist, they happen. Tense and order are features of how happenings relate within an existing world, not properties of existent objects.

Finally, consider relativity. It is a [mathematical theory](https://gutenberg.ca/ebooks/eddingtona-physicalworld/eddingtona-physicalworld-01-h-dir/eddingtona-physicalworld-01-h.html#Page_20) that describes a four-dimensional space-time continuum, and not a theory about a four-dimensional thing that exists—that, in the course of its own existence, bends and warps due to gravity.
...
Adapted from an article originally published in [The Conversation](https://theconversation.com/).
