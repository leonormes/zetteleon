...
tags: [1, 2, 3, 4, 5, 6, 7, 8, articles]
title: The Checklist Manifesto Summary 8 Lessons by Atul Gawande
---

## The Checklist Manifesto Summary: 8 Lessons by Atul Gawande

![rw-book-cover](https://assets-global.website-files.com/5d9ffc249511353e753840c9/62fb5a0685be150d73280955_the%20checklist%20manifesto.png)

### Metadata

- Author: [[Atul Gawande]]
- Full Title: The Checklist Manifesto Summary: 8 Lessons by Atul Gawande
- Category: articles
- Document Tags: [[gtd]]
- Summary: In "The Checklist Manifesto," Atul Gawande highlights how checklists can prevent failures and improve performance in various fields, including medicine. He emphasizes the importance of creating precise and effective checklists to enhance teamwork and discipline. Gawande's research shows that well-implemented checklists can significantly reduce complications and deaths in hospitals.
- URL: <https://www.runn.io/blog/the-checklist-manifesto-summary>

### Full Document

![](https://assets-global.website-files.com/5d9ffc249511353e753840c9/62fb5a0685be150d73280955_the%20checklist%20manifesto.png)
...
- [Lesson #1: Science complexity makes us fail – but there is a way out](https://www.runn.io/blog/the-checklist-manifesto-summary#lesson-1)
- [Lesson #2. A checklist is an instrument of protection against failures](https://www.runn.io/blog/the-checklist-manifesto-summary#lesson-2)
- [Lesson #3. Some checklists require a special component for a problem to be solved](https://www.runn.io/blog/the-checklist-manifesto-summary#lesson-3)
- [Lesson #4. Checklists can be different – so make sure you prepare the right one](https://www.runn.io/blog/the-checklist-manifesto-summary#lesson-4)
- [Lesson #5. To make a perfect checklist, follow the rules](https://www.runn.io/blog/the-checklist-manifesto-summary#lesson-5)
- [Lesson #6. The value of checklists is evident – yet we don’t like them](https://www.runn.io/blog/the-checklist-manifesto-summary#lesson-6)
- [Lesson #7. Checklists provide discipline, and discipline makes success possible](https://www.runn.io/blog/the-checklist-manifesto-summary#lesson-7)
- [Lesson #8. Checklists give power to those who usually don’t have it](https://www.runn.io/blog/the-checklist-manifesto-summary#lesson-8)

#### Lesson 1: Science Complexity Makes Us fail–but there is a way out
...
#### Lesson 2. A Checklist is an Instrument of Protection against Failures

##### The Story of Checklists
...
##### Faulty Memory vs. Algorithm to Follow
...
> _Checklists seem to provide protection against such failures. They remind us of the minimum necessary steps and make them explicit. They not only offer the possibility of verification but also instill a kind of discipline of higher performance._

#### Lesson 3. Some Checklists Require a Special Component for a Problem to Be Solved
...
_In the absence of a true Master Builder—a supreme, all-knowing expert with command of all existing knowledge—autonomy is a disaster. It produces only a cacophony of incompatible decisions and overlooked errors. You get a building that doesn't stand up straight._

This is why the construction workers Gawande talked to also used another checklist–the one that specified _communication_ tasks. They detailed who had to talk to whom, by which date, and about what aspect of construction; individuals could make their decisions and judgments, but they had to be discussed with other team members.
...
#### Lesson 4. Checklists Can Be different–so Make Sure You Prepare the Right One
...
1. Precise.
2. Easy to use even in the most difficult situations.
3. Provide only the most important steps.
...
2. Too long.
3. Too hard to use.
4. They treat the people who use them as dumb as they provide each and every step.
...
> _They [checklists] can help experts remember how to manage a complex process or configure a complex machine. They can make priorities clearer and prompt people to function better as a team. By themselves, however, checklists cannot make anyone follow them._

#### Lesson 5. To Make a Perfect Checklist, Follow the Rules
...
1. You must define a pause point at which a checklist is supposed to be used (unless it's obvious–for example, when a warming light goes on).
2. Decide whether you want a DO-CONFIRM or READ-DO checklist. A DO-CONFIRM LIST means that you have to pause and check if what's on the list has been done; a READ-DO list means you carry out the task as if you are following the recipe. Naturally, you pick the type of the list according to the situation.
3. A checklist cannot be too long. Try to keep it between five and nine items.
4. Focus on "the killer items", which are items most dangerous to skip (and yet often overlooked).
5. Keep the wording simple and exact. Use the language of the profession.
6. Make the checklist look simple: fit it on one page; avoid unnecessary colors; use both uppercase and lowercase.
7. Test a checklist in the real world before using it on a regular basis. The first drafts tend to fall apart. No matter how much effort you put into developing it, your checklist can fail a real-world test. So keep improving it.
...
#### Lesson 6. The Value of Checklists is evident–yet We Don't like Them
...
> _The checklist gets the dumb stuff out of the way, the routines your brain shouldn't have to occupy itself with (Did the patient get her antibiotics on time?..), and lets it rise above to focus on the hard stuff (Where should we land?)._
...
#### Lesson 7. Checklists provide Discipline, and Discipline Makes Success Possible
...
1. The expectation of selflessness. No matter who we are–teachers, police officers, soldiers, etc–we take responsibility for others, which means we place their needs above ours.
2. The expectation of skill. Professionalism means we strive for excellence.
3. The expectation of trustworthiness. We are responsible for our behavior.
...
> _We are by nature flawed and inconstant creatures. We can't even keep from snacking between meals. We are not built for discipline. We are built for novelty and excitement, not for careful attention to detail. Discipline is something we have to work at._
...
#### Lesson 8. Checklists Give Power to Those Who Usually Don't Have it
...
> _They supply a set of checks to ensure the stupid but critical stuff is not overlooked, and they supply another set of checks to ensure people talk and coordinate and accept responsibility while nonetheless being left the power to manage the nuances and unpredictabilities the best they know how._
