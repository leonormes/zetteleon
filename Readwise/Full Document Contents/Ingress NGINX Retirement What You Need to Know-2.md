...
tags: [articles]
title: Ingress NGINX Retirement What You Need to Know-2
---

## Ingress NGINX Retirement: What You Need to Know

![rw-book-cover](https://www.kubernetes.dev/favicons/apple-touch-icon-180x180.png)

### Metadata

- Author: [[Tabitha Sable]]
- Full Title: Ingress NGINX Retirement: What You Need to Know
- Category: articles
- Summary: Kubernetes is retiring Ingress NGINX and will stop maintenance in March 2026. After that there will be no fixes or security updates, though existing deployments will keep working. Users should migrate now to Gateway API or another Ingress controller.
