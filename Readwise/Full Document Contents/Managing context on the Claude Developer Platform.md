...
![rw-book-cover](https://www.anthropic.com/api/opengraph-illustration?name=Hand%20NodeWeb&backgroundColor=clay)

## Metadata
- Author: [[anthropic.com]]
- Full Title: Managing context on the Claude Developer Platform
- Category: #articles
- Summary: Anthropic's Claude Developer Platform now has tools to manage AI context better, letting agents work longer without losing important information. Context editing removes old data automatically, while the memory tool saves key details outside the limited context window. These features improve AI performance by up to 39% and help agents handle complex tasks like coding and research.
...
![Visualization comparing available context before context editing and after context editing.](https://www.anthropic.com/_next/image?url=https%3A%2F%2Fwww-cdn.anthropic.com%2Fimages%2F4zrzovbb%2Fwebsite%2F8ad2952bc0513750088cdfd309ee83ba0fd15438-1920x800.png&w=3840&q=75)Visualization comparing available context before context editing and after context editing.
