...
tags: [articles]
title: Please stop using NotebookLM as a note-taking app
---

## Please Stop Using NotebookLM as a Note-taking App

![rw-book-cover](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/10/notebooklm-next-to-coffee-mug.jpeg?w=1600&h=900&fit=crop)

### Metadata

- Author: [[Mahnoor Faisal]]
- Full Title: Please stop using NotebookLM as a note-taking app
- Category: articles
- Summary: Google's NotebookLM is designed to be a research assistant, not a traditional note-taking app. It lacks key organization features like folders, tags, and linking, making it hard to manage notes. For best results, use NotebookLM alongside a dedicated note-taking app.
- URL: <https://www.xda-developers.com/please-stop-using-notebooklm-as-a-note-taking-app/>

### Full Document

![NotebookLM next to Coffee Mug](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/10/notebooklm-next-to-coffee-mug.jpeg?&fit=crop&w=1600&h=900)

Google's NotebookLM is many things. It's not just a study buddy for stressed-out students or a research assistant for academics. It's surprisingly flexible, and honestly, half the fun is figuring out [creative ways to use it](https://www.xda-developers.com/surprising-ways-to-use-notebooklm/).

Beyond college work, I've used NotebookLM as a fitness coach, [a coffee expert to teach me how to brew better coffee](https://www.xda-developers.com/notebooklm-how-to-brew-coffee-taste-test/), a playlist curator, and more. But there's one thing it absolutely isn't, and people keep treating it like it is: a note-taking app.
...
- ![Add Sources page in NotebookLM displayed on macOS](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/10/add-sources-page-in-notebooklm-displayed-on-macos.png?q=49&fit=contain&w=750&h=422&dpr=2)
...
![Searching up NotebookLM on Google](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/10/screenshot-2025-10-31-at-8-35-22-pm.png?q=49&fit=crop&w=825&dpr=2)
...
Instead, it waits for you to bring in information you've already compiled, so it can help you understand and build on it. For instance, once you've uploaded a source (or multiple), you can convert them into an engaging podcast ([called Audio Overview](https://www.xda-developers.com/notebooklm-audio-overview-tips/)), a short explanatory video, [a mind map](https://www.xda-developers.com/notebooklm-generate-mind-maps/), or [even an organized report](https://www.xda-developers.com/ways-i-use-notebooklm-reports-feature/).
...
![All Notebooks section in NotebookLM](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/10/all-notebooks-section-in-notebooklm.png?q=49&fit=crop&w=825&dpr=2)
...
NotebookLM doesn't have a single one of those features. In fact, [this is a complaint I voiced in one of my first ever NotebookLM articles](https://www.xda-developers.com/4-features-notebooklm-should-have/) back in April. Whenever you want to use NotebookLM, you need to create a new notebook or open an existing one. Notebooks are where you add your sources, and they're the only form of organization the tool provides. While it sounds like a folder, it doesn't function like one in any meaningful way.
...
![Add Note option in NotebookLM](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/10/add-note-option-in-notebooklm.png?q=49&fit=crop&w=825&dpr=2)
...
Personally, I'm not the biggest fan of this workflow above and choose to pair NotebookLM with my note-taking apps. This way, I can get the best of both worlds and use NotebookLM the way it's meant to be used. We have a bunch of articles up on XDA that can help you pair NotebookLM with your note-taking app of choice, including [Notion](https://www.xda-developers.com/using-notebooklm-with-notion/), [Google Keep](https://www.xda-developers.com/notebooklm-plus-google-keep-productivity-powerhouse/), [Obsidian](https://www.xda-developers.com/using-notebooklm-with-obsidian/), [Apple Notes](https://www.xda-developers.com/integrated-notebooklm-with-apple-notes/), and more.
