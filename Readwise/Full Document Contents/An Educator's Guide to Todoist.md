...
![rw-book-cover](https://tdinspiration.wpengine.com/wp-content/uploads/2017/09/Todoist-Guide-for-Educators_Thumbnail.jpg)

## Metadata
- Author: [[Todoist Inspiration Hub]]
- Full Title: An Educator’s Guide to Todoist
- Category: #articles
- Document Note: Background: I want to create a clear and detailed prompt for a large language model (LLM) that explains the process described in "An Educator’s Guide to Todoist" by Todoist Inspiration Hub. This prompt will provide context so I can effectively use the LLM to assist me with planning tasks and managing my workflow based on the guide's principles.
   🌟 Clearly outline the step-by-step process for setting up and using Todoist as an educator, including organizing tasks, setting priorities, and leveraging features like labels and filters to streamline planning.
   🗂️ Emphasize how to categorize and tag tasks effectively to maintain clarity and focus, ensuring that all educational responsibilities are tracked and manageable within Todoist.
   ⏰ Highlight the importance of scheduling and timely reviews within Todoist to keep plans up-to-date, prioritize tasks appropriately, and adapt to changing educational demands.
- Summary: "An Educator’s Guide to Todoist" provides valuable tips for educators to efficiently manage tasks and stay organized using the Todoist productivity app. The guide suggests creating projects for each course, dividing tasks into sections like lectures and office hours, and setting due dates for better task management. It also highlights the benefits of setting task reminders, syncing tasks with calendars, and assessing goals regularly to enhance productivity. Additionally, educators can leverage features like sub-tasks, priority levels, labels, comments, file attachments, and recurring tasks to streamline lesson planning, grading, collaboration, and meeting preparation within the app.
- URL: https://www.todoist.com/inspiration/an-educators-guide-to-todoist

## Full Document
![](https://res.cloudinary.com/imagist/image/fetch/f_auto/q_auto/c_scale,w_2624/https://tdinspiration.wpengine.com/wp-content/uploads/2017/09/Todoist-Guide-for-Educators_Thumbnail.jpg?_a=BATCtdJs0)Illustration by [Yin Weihung](https://dribbble.com/yin-weihung)
...
Having a productivity system, powered by a task manager that works as hard as you do, is a great first step. That’s where [Todoist](https://todoist.com/) comes in. Whether you have an hour to quietly plan between classes, or you’re on the go between hectic meetings, a reliable productivity app will help you to quickly capture, organize, and prioritize everything you need to do. This Educator’s Guide to Todoist will provide workflow tips to help you get ahead your lesson plans, stay on top of your grading, and keep up to date with the new developments in your field to keep your students informed.
...
![blog_todoist-for-educators_1_resize](https://res.cloudinary.com/imagist/image/fetch/f_auto/q_auto/c_scale,w_2624/https://tdinspiration.wpengine.com/wp-content/uploads/2017/09/blog_todoist-for-educators_1_resize.png?_a=BATCtdJs0)
If a course has multiple components to it, keep them separate using [sub-projects](https://support.todoist.com/hc/en-us/articles/115001862065-Create-a-sub-project). For instance, you may teach the lecture and run the seminar of an English course.

##### Divide your project into sections

Every class you teach probably requires a range of work –– from assigning homework and grading exams to providing student evaluations and creating assessments. To organize these different kinds of tasks, split your Todoist project into different segments using [sections](https://todoist.com/help/articles/introduction-to-sections). For instance you could divide your course into the following sections:
...
![blog_todoist-for-educators_2](https://res.cloudinary.com/imagist/image/fetch/f_auto/q_auto/c_scale,w_2624/https://tdinspiration.wpengine.com/wp-content/uploads/2017/09/blog_todoist-for-educators_2.png?_a=BATCtdJs0)
##### Capture and organize all your tasks, big and small

With your Todoist account structured around your teaching roster, you’re ready to add tasks. At the start of the semester or quarter, [add tasks and key dates](https://support.todoist.com/hc/en-us/articles/115001745265) that you’re aware of in advance — important exams, project deadlines, field trip days, professional development conferences, and other events you’ll need to plan for.

Of course, no matter how well you plan in advance, new things come up all the time. Trying to keep everything straight in your head is stressful and often leads to important tasks getting missed. [Assign a due date](https://support.todoist.com/hc/en-us/articles/205325931) to each task to help you keep track of upcoming deadlines and plan accordingly.
...
With Todoist, you can capture and organize your tasks from wherever you are — [Todoist’s apps are available on over 10 platforms](https://goo.gl/KzjEU2), including iOS and Android. That means you can effortlessly add tasks the moment they come to you whether you’re on the computer in a classroom, on your tablet while facilitating a study session, or on your phone during your train commute home.

[Dr. Robyn Wiens](https://blog.todoist.com/user-stories/hawthorn-girls-leadership-school/), principal of Hawthorn Leadership School for Girls, says the ability to quickly add tasks from anywhere helps her be more present while away from work:
...
If you’re a [Todoist Pro user](https://todoist.com/pricing), stay on top of your meetings and other time-specific tasks by setting [reminders](https://support.todoist.com/hc/en-us/articles/205348301) in Todoist on your desktop or phone. You can set date and time reminders or location reminders:
...
![blog_todoist-for-educators_3](https://res.cloudinary.com/imagist/image/fetch/f_auto/q_auto/c_scale,w_2624/https://tdinspiration.wpengine.com/wp-content/uploads/2017/09/blog_todoist-for-educators_3.png?_a=BATCtdJs0)
##### Sync your to-do list with your calendar

If you’re like most teachers, your day revolves around your calendar. With the [Google Calendar and Todoist integration](https://todoist.com/inspiration/google-calendar-todoist-integration/), your schedule and your tasks can go hand-in-hand.
...
![blog_todoist-for-educators_4](https://res.cloudinary.com/imagist/image/fetch/f_auto/q_auto/c_scale,w_2624/https://tdinspiration.wpengine.com/wp-content/uploads/2017/09/blog_todoist-for-educators_4.png?_a=BATCtdJs0)
...
Craig McClennan, an Elementary School Teacher from Nashville, Tennessee, finds that [Todoist Karma](https://support.todoist.com/hc/en-us/articles/206209959) has been invaluable for setting productivity goals and assessing his progress regularly: “Just having daily goals in Karma helps me keep my head above water.”

![blog_todoist-for-educators_5](https://res.cloudinary.com/imagist/image/fetch/f_auto/q_auto/c_scale,w_2624/https://tdinspiration.wpengine.com/wp-content/uploads/2017/09/blog_todoist-for-educators_5.png?_a=BATCtdJs0)
...
* **[View all of your completed tasks](https://support.todoist.com/hc/en-us/articles/205847912):** Having a chronological list of everything you’ve completed is valuable when answering the question, “Where did all my time go?” Browse through to see the days where meetings and coordination might have eaten into your planning and prep.
...
Creating a lesson plan from scratch is no easy feat. Developing one for a course could include setting objectives, defining learning outcomes, creating relevant assignments and assessments, acquiring any necessary resource materials, and developing key talking points that align with the curriculum. Simply adding one task to your list to encapsulate all of those items can be a recipe for feeling stressed and overwhelmed. That’s where Todoist [sub-tasks](https://support.todoist.com/hc/en-us/articles/206432369-Sub-tasks) can help.
...
![blog_todoist-for-educators_6_resize](https://res.cloudinary.com/imagist/image/fetch/f_auto/q_auto/c_scale,w_2624/https://tdinspiration.wpengine.com/wp-content/uploads/2017/09/blog_todoist-for-educators_6_resize.png?_a=BATCtdJs0)
Make your to-do list as efficient as possible by adding all the information you need to every task. When adding a to-do in Todoist, open up the [task view](https://todoist.com/help/articles/manage-a-task-with-task-view) to add all the details.
...
Prioritize your tasks in Todoist by selecting one of four [priority levels](https://support.todoist.com/hc/en-us/articles/205873321). For each task, you have the option of categorizing it as Priority 1, 2, 3, or 4, with 1 being the most important and 4 being the least important. When you view your tasks for the day, your highest priority tasks, marked in red, will appear at the top.

![blog_todoist-for-educators_8_resize](https://res.cloudinary.com/imagist/image/fetch/f_auto/q_auto/c_scale,w_2624/https://tdinspiration.wpengine.com/wp-content/uploads/2017/09/blog_todoist-for-educators_8_resize.png?_a=BATCtdJs0)
...
You can use Todoist [labels](https://support.todoist.com/hc/en-us/articles/205195042) to quickly group the tasks across all of your projects that take 15 minutes or less. Just type @15min into the task field, and hit enter. The label will automatically be added to the task. Whenever you find yourself with a small 15-minute block of open time, search for “@15min” to pull up all of the associated tasks in seconds.

![blog_todoist-for-educators_9](https://res.cloudinary.com/imagist/image/fetch/f_auto/q_auto/c_scale,w_2624/https://tdinspiration.wpengine.com/wp-content/uploads/2017/09/blog_todoist-for-educators_9.png?_a=BATCtdJs0)
...
![blog_todoist-for-educators_11_resize](https://res.cloudinary.com/imagist/image/fetch/f_auto/q_auto/c_scale,w_2624/https://tdinspiration.wpengine.com/wp-content/uploads/2017/09/blog_todoist-for-educators_11_resize.png?_a=BATCtdJs0)
...
![blog_todoist-for-educators_10_resize](https://res.cloudinary.com/imagist/image/fetch/f_auto/q_auto/c_scale,w_2624/https://tdinspiration.wpengine.com/wp-content/uploads/2017/09/blog_todoist-for-educators_10_resize.png?_a=BATCtdJs0)
...
Download Todoist for [Gmail](https://chrome.google.com/webstore/detail/todoist-for-gmail/clgenfnodoocmhnlnpknojdbjjnmecff?hl=en) or [Outlook](https://goo.gl/4ALQPo) and [turn emails into tasks](https://todoist.com/inspiration/inbox-zero-with-todoist) from right inside your inbox.
...
Grade assignments more efficiently by automating the submission flow with [Zapier](https://zapier.com/), a service that lets you connect the apps you already use and set up automated workflows with Todoist — all without writing a line of code. Rather than digging through your inbox to find and sort email assignment submissions from students, follow these steps:

1. Require your students to submit assignments to you with a specific naming convention in the subject of the email (e.g., Firstname\_Lastname\_CourseCode-SectionCode\_Assignment Name)
2. [Set up the following Zap on Zapier](https://zapier.com/app/editor/template/1437): “Add emails matching certain conditions to Todoist as tasks”
...
![blog_todoist-for-educators_12](https://res.cloudinary.com/imagist/image/fetch/f_auto/q_auto/c_scale,w_2624/https://tdinspiration.wpengine.com/wp-content/uploads/2017/09/blog_todoist-for-educators_12.png?_a=BATCtdJs0)
...
As a teacher, grading quizzes, assignments, and exams is an ongoing task. Reflect those repeating tasks in Todoist with [recurring due dates](https://support.todoist.com/hc/en-us/articles/205325931-Due-Dates-Times). Determine when you’re regularly in grading mode and schedule accordingly.
...
Todoist’s smart [Quick Add](https://todoist.com/help/articles/task-quick-add) will automatically recognize the due date as you type it in and schedule your recurring tasks accordingly. Whenever you complete a recurring task, it will automatically reschedule for the next due date.
...
![blog_todoist-for-educators_15](https://res.cloudinary.com/imagist/image/fetch/f_auto/q_auto/c_scale,w_2624/https://tdinspiration.wpengine.com/wp-content/uploads/2017/09/blog_todoist-for-educators_15.png?_a=BATCtdJs0)
...
Use Todoist’s extensions for [Chrome](https://chrome.google.com/webstore/detail/todoist-to-do-list-and-ta/jldhpllghnbhlbpcmnajkpdmadaolakh?hl=en), [Firefox](https://addons.mozilla.org/en-US/firefox/addon/todoist/), or [Safari](https://goo.gl/QtDMZo) to save links to interesting articles and papers that you find in academic journals, industry email newsletters, and authoritative websites directly to your Todoist task list for later reading.
...
* **Add your routines to Todois**t: Ease into the morning or wind down at night by including your routines as tasks. For instance, create a recurring “morning routine” task with subtasks like “stretching,” “coffee,” and “play with the kids.”
...
* [**Add your personal projects to Todoist favorites**](https://todoist.com/inspiration/introducing-todoist-favorites/): Stay balanced and keep your personal life top-of-mind by keeping projects like “Health” and “Hobbies” where you can always see them.
...
Ready to get organized for the coming school year? [Create your own Todoist for free](https://goo.gl/vnVX51). Could your students use a little help in the organization department? Share our accompanying [Student’s Guide to Todoist](https://todoist.com/inspiration/todoist-guide-for-students).
