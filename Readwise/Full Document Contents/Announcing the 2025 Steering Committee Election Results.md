...
- Full Title: Announcing the 2025 Steering Committee Election Results
- Category: #articles
- Summary: The 2025 Kubernetes Steering Committee election is finished, and four new members were chosen for two-year terms. The committee guides the Kubernetes project and welcomes community involvement. Meeting notes and past recordings are publicly available for anyone who wants to learn more or participate.
...
This governing body, like all of Kubernetes, is open to all. You can follow along with Steering Committee [meeting notes](https://bit.ly/k8s-steering-wd) and weigh in by filing an issue or creating a PR against their [repo](https://github.com/kubernetes/steering). They have an open meeting on [the first Monday at 8am PT of every month](https://github.com/kubernetes/steering). They can also be contacted at their public mailing list [steering@kubernetes.io](mailto:steering@kubernetes.io).
...
*This post was adapted from one written by the [Contributor Comms Subproject](https://github.com/kubernetes/community/tree/master/communication/contributor-comms). If you want to write stories about the Kubernetes community, learn more about us.*
