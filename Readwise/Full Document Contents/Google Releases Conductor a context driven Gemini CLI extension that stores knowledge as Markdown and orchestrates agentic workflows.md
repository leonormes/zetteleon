...
![rw-book-cover](https://www.marktechpost.com/wp-content/uploads/2026/02/blog-banner23-3.png)

### Metadata

- Author: [[Michal Sutter - February 2]]
- Full Title: Google Releases Conductor: a context driven Gemini CLI extension that stores knowledge as Markdown and orchestrates agentic workflows
- Category: articles
- Summary: Google released Conductor, a Gemini CLI extension that organizes AI coding with versioned Markdown files to keep project context clear and consistent. It helps teams plan work in tracks with detailed specs and step-by-step plans before writing code. This makes AI coding repeatable, reviewable, and easier to manage across projects and teams.
...
3. Run tests or checks according to `conductor/workflow.md`.
4. Update task status in `plan.md` and global `tracks.md`.
