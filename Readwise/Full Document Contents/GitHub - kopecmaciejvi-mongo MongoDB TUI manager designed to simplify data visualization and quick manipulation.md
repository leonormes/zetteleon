...
tags: [articles]
title: GitHub - kopecmaciejvi-mongo MongoDB TUI manager designed to simplify data visualization and quick manipulation
---

## GitHub - kopecmaciej/vi-mongo: MongoDB TUI Manager Designed to Simplify Data Visualization and Quick Manipulation

![rw-book-cover](https://opengraph.githubassets.com/1e921f6487255f7be35bbc39998b8531bf9afbb6159c5be6a9fa0cf6c3a1d237/kopecmaciej/vi-mongo)

### Metadata

- Author: [[https://github.com/kopecmaciej/]]
- Full Title: GitHub - kopecmaciej/vi-mongo: MongoDB TUI manager designed to simplify data visualization and quick manipulation
- Category: articles
- Summary: Vi Mongo is a simple terminal app made to help manage MongoDB databases easily. It lets users quickly switch databases and edit data with features like autocomplete and query history. The tool is open for contributions and supports multiple color themes.
...
[![](https://github.com/kopecmaciej/vi-mongo/raw/master/assets/logo/no-background.svg)](https://github.com/kopecmaciej/vi-mongo/blob/master/assets/logo/no-background.svg)
...
[![autocomplete](https://github.com/kopecmaciej/vi-mongo/raw/master/assets/autocomplete.webp)](https://github.com/kopecmaciej/vi-mongo/blob/master/assets/autocomplete.webp)
...
For now all issues are resolved, but if you find any new issues, please report them in the [GitHub Issues](https://github.com/kopecmaciej/vi-mongo/issues) page.
