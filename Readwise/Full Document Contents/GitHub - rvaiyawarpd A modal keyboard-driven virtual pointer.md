...
tags: [articles]
title: GitHub - rvaiyawarpd A modal keyboard-driven virtual pointer
---

## GitHub - rvaiya/warpd: A Modal Keyboard-driven Virtual Pointer

![rw-book-cover](https://opengraph.githubassets.com/0c35dbc60ff34f8d0d1b9f32fccd36f3e8ee6ee0971dcd4ae9125c14d4cb9f25/rvaiya/warpd)

### Metadata

- Author: [[https://github.com/rvaiya/]]
- Full Title: GitHub - rvaiya/warpd: A modal keyboard-driven virtual pointer
- Category: articles
- Summary: This document provides detailed information on rvaiya/warpd, a modal keyboard-driven interface for mouse manipulation. It outlines different modes such as Hint Mode, Grid Mode, and Normal Mode, along with installation instructions for various systems like Debian/Ubuntu and MacOS. Quickstart guides for each mode are included, along with notes on using Wayland and the limitations/bugs of the software. Additionally, the document acknowledges contributions and offers packages available on Arch Linux.
...
[![](https://github.com/rvaiya/warpd/raw/master/demo/hints.gif)](https://github.com/rvaiya/warpd/blob/master/demo/hints.gif)

  [![hints.gif](https://github.com/rvaiya/warpd/raw/master/demo/hints.gif)](https://github.com/rvaiya/warpd/blob/master/demo/hints.gif)

##### Grid Mode `Alt-Meta-g`

[![](https://github.com/rvaiya/warpd/raw/master/demo/warp.gif)](https://github.com/rvaiya/warpd/blob/master/demo/warp.gif)

  [![warp.gif](https://github.com/rvaiya/warpd/raw/master/demo/warp.gif)](https://github.com/rvaiya/warpd/blob/master/demo/warp.gif)

##### Normal Mode `Alt-Meta-c`

[![](https://github.com/rvaiya/warpd/raw/master/demo/discrete.gif)](https://github.com/rvaiya/warpd/blob/master/demo/discrete.gif)

  [![discrete.gif](https://github.com/rvaiya/warpd/raw/master/demo/discrete.gif)](https://github.com/rvaiya/warpd/blob/master/demo/discrete.gif)

[![](https://github.com/rvaiya/warpd/raw/master/demo/discrete2.gif)](https://github.com/rvaiya/warpd/blob/master/demo/discrete2.gif)

  [![discrete2.gif](https://github.com/rvaiya/warpd/raw/master/demo/discrete2.gif)](https://github.com/rvaiya/warpd/blob/master/demo/discrete2.gif)
...
_Note:_ The wayland port has several limitations due to the nature of Wayland's architecture.
...
A more comprehensive description can be found in the [man page](https://github.com/rvaiya/warpd/blob/master/warpd.1.md) (along with a list of options).

##### Wayland

_Note:_ Wayland does not permit clients to globally bind hotkeys. These must be bound within the compositor using warpd's oneshot flags.
...
- Programs which use Xinput and or Xtest for keyboard may not work correctly (e.g synergy). If a specific program which you feel should be working does not please file an [issue](https://github.com/rvaiya/warpd/issues).
