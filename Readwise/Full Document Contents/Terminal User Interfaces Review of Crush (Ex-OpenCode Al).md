...
tags: [articles]
title: Terminal User Interfaces Review of Crush (Ex-OpenCode Al)
---

## Terminal User Interfaces: Review of Crush (Ex-OpenCode Al)

![rw-book-cover](https://cdn.thenewstack.io/media/2025/08/a6a37561-marko-brecic-b-uijdf_pzk-unsplashb.jpg)

### Metadata

- Author: [[David Eastman]]
- Full Title: Terminal User Interfaces: Review of Crush (Ex-OpenCode Al)
- Category: articles
- Summary: Crush is a new open-source command line tool that adds AI help to your terminal for coding and debugging. It supports many AI models and lets you switch between them while keeping your work context. Although still developing, Crush shows promise with its unique text interface and permission controls.
- URL: <https://share.google/FcKmHV4V6xr3waVLo>

### Full Document

![Featued image for: Terminal User Interfaces: Review of Crush (Ex-OpenCode Al)](https://cdn.thenewstack.io/media/2025/08/a6a37561-marko-brecic-b-uijdf_pzk-unsplashb-1024x576.jpg)Image via Unsplash+.
