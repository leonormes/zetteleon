...
tags: [articles]
title: Time blocking what it is and how to do it (plus apps)
---

## Time Blocking: what it is and how to Do it (plus apps)

![rw-book-cover](https://clockify.me/blog/wp-content/uploads/2019/06/Time-blocking-social-media.png)

### Metadata

- Author: [[Marija Kojic]]
- Full Title: Time blocking: what it is and how to do it (plus apps)
- Category: articles
- Summary: Time blocking involves scheduling specific time blocks for your tasks and activities. It helps you focus on priorities and track how you spend your time. Using time blocking can improve your productivity and balance work with personal life.
- URL: <https://clockify.me/blog/productivity/time-blocking/>

### Full Document

The exceptional entrepreneur Elon Musk always managed to find time for his kids, all while working [120+ hours per week](https://clockify.me/blog/productivity/how-to-manage-efficiently-working-80-hours-week/) and making plans with NASA to colonize Mars–thanks to a time management technique called time blocking.
...
These priorities can be [recurring tasks](https://clockify.me/time-spent-on-recurring-tasks) you tackle every day, like answering important emails or handling client calls. Or, they can be tasks you tackle every-so-often, like handling some urgent administration work, or conducting research for your new project.
...
- _When_ you need to block time, by defining specific start and end times
- _For how long_ you need to block time, by defining the task duration
...
Clockify pro tip
 ...
 Still unsure what your optimal time for productivity is? Check out our guide to the [Best Time Management Techniques](https://clockify.me/time-management-techniques) to learn how to analyze your biological prime time and pinpoint your personal optimal time for priority work.

Alternatively, you can schedule your most important, urgent, or, simply, the most difficult task first thing in the morning–this practice is known as [“eating your frog”](https://clockify.me/blog/productivity/eat-frog-technique/), and it allows you to clear the rest of your daily schedule for more pleasant tasks as soon as possible.

###### For how long You Need to Block time

According to the science of Ultradian rhythms, peoples' minds work in 90-minute cycles–and, according to the popular [Pomodoro principle](https://clockify.me/blog/productivity/pomodoro-technique/), you should parse your workday into 25-minute work-time and 5-minute break-time.
...
![25 i 90 minute time blocks](https://clockify.me/blog/wp-content/uploads/2019/06/25-i-90-minute-time-blocks.png)

These are just some science-based suggestions for your time blocks–you may want to use your own custom time blocks.

Once you've decided how you'll handle your time blocks, simply add them to your calendar.

![blocking stage, the calendar](https://clockify.me/blog/wp-content/uploads/2019/06/blocking-stage-the-calendar.png)

##### 3. Act on Your Schedule

Once you've selected the _what_, and defined the _when_ and _for how long_, you'll need to "act" on your promises and follow your schedule.
...
![revision stage - too much time allocated](https://clockify.me/blog/wp-content/uploads/2019/06/revision-stage-too-much-time-allocated.png)

Perhaps you'll find that you take 2 hours to tackle critical bugs in your program, so your schedule falls half an hour short.

![revision stage - too little time allocated](https://clockify.me/blog/wp-content/uploads/2019/06/revision-stage-too-little-time-allocated.png)

Either way, you should change your approachnext time you create a schedule, use your real-life time tracking results for each task to define time blocks. With time tracking, you'll already have proof they work, so you'll know you'll finish on schedule.
...
You can also reserve empty time slots for your priority tasks–if you've calculated your [biological prime time](https://clockify.me/time-management-techniques#time-management-techniques-11), you'll understand when your most effective time window is, and you'll know to always reserve these pre-made time slots for your priority tasks.

![time blocking template](https://clockify.me/blog/wp-content/uploads/2019/06/time-blocking-template.png)

Clockify pro tip

 Want to use ready-made time blocking templates for your tasks instead? We've got you covered with our [9 free time blocking templates](https://clockify.me/blog/productivity/time-blocking-planner-templates/) you can download in PDF and then print out, or fill out in Google Sheets.

###### Follow Theme Days

You can do various tasks during the day, or you can define theme days when you'll tackle only a certain type of tasks–The CEO of Twitter, Jack Dorsey, [follows this practice](https://clockify.me/daily-routines-habits-productive-people), so he spends entire Tuesdays on product-related activities, and entire Wednesdays on marketing activities.
...
This way, you'll fully immerse yourself in one type of activity, [avoid multitasking](https://clockify.me/blog/productivity/switch-between-projects-and-tasks/), and make sure you have the tools and materials you need for this type of task.
...
- _Time tracker_ to track the time on your activities in real-time, understand how much time you need to finish each task, and define accurate time blocks in your calendar
- _To-do app, task management app, organizer, or planner_, to help you better understand and keep an eye on your priority tasks for today, or any upcoming time period
- _Calendar app_, preferably with deadline and reminder features, to help you plan your time blocks, and make sure you leave yourself time for everything you have to do

Here are the best apps for time blocking:
...
- TimeBlocks–mobile planner, calendar, and organizer app
- Jorte–calendar and personal organizer
- Cozi–a family organizer

##### Clockify–time Tracker App

![Clockify time tracker app](https://clockify.me/blog/wp-content/uploads/2019/06/Clockify-1.png)

Clockify is a time tracker app with efficient [time blocking features](https://clockify.me/time-blocking-app)–you'll be able to track the time you spend on your scheduled time blocks as you work on them, and figure out whether you'll need to make revisions for the same time blocks in the future.
...
- Use the [integration with Google Calendar](https://clockify.me/google-calendar-time-tracking) to track time on scheduled events and tasks without ever leaving Google Calendar
...
![Google Calendar classic calendar app](https://clockify.me/blog/wp-content/uploads/2019/06/Google-Calendar.png)
...
![Any.do task manager and calendar assistant](https://clockify.me/blog/wp-content/uploads/2019/06/Any.do_.png)
...
![to do list app](https://clockify.me/blog/wp-content/uploads/2019/06/Todoist.png)
...
Clockify pro tip
 ...
 You can easily track time on Todoist to-dos with the [Clockify-Todoist integration](https://clockify.me/todoist-time-tracking).

##### Edo Agenda–agenda Organizer

![Edo Agenda agenda organizer](https://clockify.me/blog/wp-content/uploads/2019/06/Edo-Agenda.png)

Edo Agenda is an agenda organizer and personal workspace meant to help you be more productive, while also leaving enough time for you to practice your creative side on creative tasks.
...
![fantastical2 mac calendar app](https://clockify.me/blog/wp-content/uploads/2019/06/fantastical2-mac.png)

Fantastical 2 is a Mac-exclusive calendar app with the usual time-blocking-friendly calendar features–you'll be able to reorganize your schedule around team priorities, but also duplicate events across calendars and view your weekly agenda in a couple of clicks.
...
Clockify pro tip
 ...
 If you're a Mac user, you can [use Clockify to track time in Pomodoro intervals](https://clockify.me/mac-time-tracking), directly from the app.

##### Remember the Milk–to-do List and Task Management App

![Remember the Milk task management app](https://clockify.me/blog/wp-content/uploads/2019/06/Remember-the-Milk.png)
...
![Digical daily planner](https://clockify.me/blog/wp-content/uploads/2019/06/Digical.png)
...
![Things task management app](https://clockify.me/blog/wp-content/uploads/2019/06/Things.png)

Things is another task management app with a journal-like view–you'll be able to make to-do lists, compile shopping and grocery lists, view tasks grouped by projects, and add notes to them. And all that according to the Getting Things Done methodology.
...
![Timeblocks mobile planner](https://clockify.me/blog/wp-content/uploads/2019/06/Timeblocks.png)

TimeBlocks is a mobile planner and calendar app meant to help you streamline business and personal scheduling.
...
![Jorte calendar and personal organizer](https://clockify.me/blog/wp-content/uploads/2019/06/Jorte.png)

Jorte is essentially an international personal organizer and event calendar–it's dubbed the most fully-functional calendar app on the market, and its features do hint at that.
...
- elevate your time blocking experience by personalizing your fonts (most OTF and TTF fonts supported)
...
![Cozi family organizer](https://clockify.me/blog/wp-content/uploads/2019/06/Cozi.png)

Cozi is a calendar app meant to help you block time for and organize family-oriented activities–you'll be able to add activities to a to-do list, sync them with other family member's available time slots, as well as set reminders to make sure everyone is always kept up to date.
