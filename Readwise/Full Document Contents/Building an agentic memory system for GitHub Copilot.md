...
![rw-book-cover](https://github.blog/wp-content/uploads/2025/12/memory.jpg)

### Metadata

- Author: [[Tiferet Gazit]]
- Full Title: Building an agentic memory system for GitHub Copilot
- Category: articles
- Summary: GitHub Copilot now uses a shared memory system that helps its agents learn and remember code patterns across tasks. This memory is verified in real-time to stay accurate and relevant as code changes. Using this system, Copilot improves coding help and review, making developers more efficient and reducing errors.
- URL: <https://share.google/MvEJhdNKW4fyiyuQF>

### Full Document

![A decorative image of the GitHub Copilot logo.](https://github.blog/wp-content/uploads/2025/12/memory.jpg?w=1600)A decorative image of the GitHub Copilot logo.
...
![A flow chart showing how Copilot agents store learnings worth remembering as they carry out their tasks.](https://github.blog/wp-content/uploads/2026/01/01_Memory_generation-Blog-1200x630_15-12-25_1.jpg?w=2400)How Copilot agents store learnings worth remembering as they carry out their tasks.
...
![](https://github.blog/wp-content/uploads/2026/01/02_Memory_usage-Blog-1200x630_15-12-25_1.jpg?w=2400)How Copilot enriches agent prompts with memories from previous tasks.
...
![Mona floating among green cubes featuring GitHub invertocat logos in a decorative scene.](https://github.blog/wp-content/uploads/2026/01/generic-mona-invertocat-logo.png?w=1600)Mona floating among green cubes featuring GitHub invertocat logos in a decorative scene.
