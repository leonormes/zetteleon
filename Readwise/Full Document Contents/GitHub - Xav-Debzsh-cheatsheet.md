...
tags: [articles]
title: GitHub - Xav-Debzsh-cheatsheet
---
...
_1. Type a command (e.g., `git`) to set the context._
...
_2. Press `Ctrl+H` to open the interactive cheat sheet, filter with fzf, and press Enter to insert._
...
_Built with ❤️ for the Zsh community._
