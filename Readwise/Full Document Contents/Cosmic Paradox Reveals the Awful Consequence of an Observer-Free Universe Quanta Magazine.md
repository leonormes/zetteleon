...
tags: [articles]
title: Cosmic Paradox Reveals the Awful Consequence of an Observer-Free Universe Quanta Magazine
---

## Cosmic Paradox Reveals the Awful Consequence of an Observer-Free Universe | Quanta Magazine

![rw-book-cover](https://www.quantamagazine.org/wp-content/uploads/2025/11/OneStateUniverse-crKristinaArmitage-Social.jpg)

### Metadata

- Author: [[Matt von Hippel]]
- Full Title: Cosmic Paradox Reveals the Awful Consequence of an Observer-Free Universe | Quanta Magazine
- Category: articles
- Summary: Physicists found calculations suggesting closed universes have only one possible quantum state, which clashes with the complex world we see. Recent work shows that including an observer—a local, classical boundary—restores the universe's rich information. If true, this implies physics may need observer-dependent descriptions rather than a single objective view.
- URL: <https://share.google/NW15dlkaMOVuvOfRq>
...
![An eye containing the universe](https://www.quantamagazine.org/wp-content/uploads/2025/11/OneStateUniverse-crKristinaArmitage-Lede-scaled.webp)
...
"We look around, and certainly the world seems more complex than that," said [Rob Myers](https://perimeterinstitute.ca/people/robert-myers), a theoretical physicist at the Perimeter Institute for Theoretical Physics in Waterloo, Canada, who has not been directly involved in this research.
...
Holography has delivered major breakthroughs. In 2019, Maldacena and three colleagues at IAS—[Ahmed Almheiri](https://nyuad.nyu.edu/en/academics/divisions/science/faculty/ahmed-eid-khamis-thani-almheiri.html), [Raghu Mahajan](https://web.stanford.edu/~rm89/) and [Ying Zhao](https://physics.mit.edu/faculty/ying-zhao/)—used holographic thinking to better understand what happens inside a black hole. Building on [earlier](https://arxiv.org/abs/1905.08762) [work](https://arxiv.org/abs/1905.08255), they proposed the "[island formula](https://arxiv.org/abs/1908.10996)," which tracks the boundaries of different regions within a black hole. It soon helped them and others to uncover a potential explanation for a long-standing mystery: How can black holes reveal information about what has fallen into them—which quantum theory says must happen—when doing so would seem to defy the absolute nature of a black hole's gravity? Their success gave physicists confidence that the island formula was a trustworthy way of understanding quantum gravity, and subsequent results showed that it could hold its own outside its original anti-de Sitter context.

But it was merely a warm-up.

"Black holes are a really good testing ground for ideas, but they're not where the money is," said [Henry Maxfield](https://qfarm.stanford.edu/people/henry-maxfield), a physicist at Stanford University. "The important question of quantum gravity is quantum cosmology"—the push to understand the very early universe.
...
![A woodcut engraving of a man pushing his head through a boundary between earth and sky.](https://www.quantamagazine.org/wp-content/uploads/2025/11/Flammarion-Engraving-crPublic-Domain.webp)
...
![A man in a blue shirt before a brick wall.](https://www.quantamagazine.org/wp-content/uploads/2025/11/Edgar-Shaghoulian-cr-Alexa-Fredston.webp)
...
"On my desk there are an infinite number of states," said [Edgar Shaghoulian](https://edgarshaghoulian.com/), a physicist at the University of California, Santa Cruz.

But as physicists continued to study different types of closed universes, they kept seeing the same pattern. While the IAS group considered black holes, Maxfield and his collaborator Donald Marolf [looked at](https://arxiv.org/abs/2002.08950) hypothetical quantum bubbles of space-time called baby universes. They found the same stark simplicity. Increasingly, it appeared that the barrenness of closed universes was a universal trend.
...
![A woman in a pink sweater in front of a chalk board.](https://www.quantamagazine.org/wp-content/uploads/2025/11/Ying-Zhao-cr-Courtesy-of-Ying-Zhao.webp)
...
[The MIT team’s paper](https://arxiv.org/abs/2501.02359) came out at the beginning of 2025, around the same time that another group came forward with a [similar idea](https://arxiv.org/abs/2501.02632). Others [chimed in](https://arxiv.org/abs/2507.10649) to point out connections to earlier work.
...
"Am I really confident to say that it's right, it's _the_ thing that solves the problem? I cannot say that. We try our best," Zhao said.
