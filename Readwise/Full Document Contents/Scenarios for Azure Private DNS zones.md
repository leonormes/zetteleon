...
- Author: [[asudbring]]
- Full Title: Scenarios for Azure Private DNS zones
- Category: articles
- Summary: Azure Private DNS zones let you resolve names privately within one or multiple virtual networks. You can link networks to share DNS records or use split-horizon to have different public and private DNS for the same domain. This helps keep network naming secure and simple inside Azure.
...
![Multiple Virtual network resolutions](https://learn.microsoft.com/en-us/azure/dns/media/private-dns-scenarios/multi-vnet-resolution.png)
...
![Split Brian resolution](https://learn.microsoft.com/en-us/azure/dns/media/private-dns-scenarios/split-brain-resolution.png)

#### Next Steps

To learn more about Private DNS zones, see [Using Azure DNS for private domains](https://learn.microsoft.com/en-us/azure/dns/private-dns-overview).

Learn how to [create a Private DNS zone](https://learn.microsoft.com/en-us/azure/dns/private-dns-getstarted-powershell) in Azure DNS.
