...
![rw-book-cover](https://regmedia.co.uk/2020/11/20/ai.jpg)

## Metadata
- Author: [[Tim Anderson]]
- Full Title: From Agile to AI: Anniversary workshop says test-driven development ideal for AI coding
- Category: #articles
- Summary: Experts say test-driven development (TDD) is very important for coding with AI. AI changes how software is built, but engineering discipline must stay strong. The shift to AI tools brings challenges like security risks and slower project decisions.
- URL: https://www.theregister.com/2026/02/20/from_agile_to_ai_anniversary/
...
"Test-driven development (TDD) produces dramatically better results from AI coding agents," [says the report](https://www.thoughtworks.com/content/dam/thoughtworks/documents/report/tw_future%20_of_software_development_retreat_%20key_takeaways.pdf) [PDF] on the workshop.
...
The [Agile Manifesto](https://agilemanifesto.org/) was composed by a group of IT professionals in February 2001, and influential in its promotion of a collaborative, flexible and iterative approach to software development. One of its signatories was Martin Fowler, chief scientist at software development company Thoughtworks. Fowler and Thoughtworks hosted the [workshop](https://www.thoughtworks.com/about-us/events/the-future-of-software-development) 25 years on, to "rethink how software is built" in the light of "a new inflection point: the shift to AI-native software development."
...
In the light of this AI shift, should there now be a new manifesto?" No, "it's way too early," [said Fowler](https://www.youtube.com/watch?v=VHkuVlwYhNk). "People are still experimenting with ideas, still trying stuff."
