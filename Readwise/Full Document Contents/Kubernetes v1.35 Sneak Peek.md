...
modified: 2026-03-14T11:10:03+00:00
tags: [articles]
...
- Full Title: Kubernetes v1.35 Sneak Peek
- Category: articles
- Summary: Kubernetes v1.35 will remove support for legacy features like cgroup v1 and ipvs mode to improve performance and security. New enhancements include better pod resource updates, native pod certificates, and smarter node feature declarations. The release aims to make Kubernetes more reliable, secure, and easier to manage by December 2025.
