...
![rw-book-cover](https://zed.dev/img/acp/og-dark.webp)

## Metadata
- Author: [[Agent Client Protocol]]
- Full Title: Introduction
- Category: #articles
- Summary: The Agent Client Protocol (ACP) lets code editors and AI coding agents communicate using one standard method. This stops the need for custom integrations and lets agents work with many editors easily. ACP works both locally and remotely, helping developers use the best tools without limits.
- URL: https://agentclientprotocol.com/get-started/introduction

## Full Document
The Agent Client Protocol (ACP) standardizes communication between code editors/IDEs and coding agents and is suitable for both local and remote scenarios. AI coding agents and editors are tightly coupled but interoperability isn’t the default. Each editor must build custom integrations for every agent they want to support, and agents must implement editor-specific APIs to reach users. This creates several problems:
