...
|------|-------|---------------------|
| [[Qdrant Is a Vector Search Engine That Enables Semantic Rather Than Keyword Retrieval]] | 2 | [[SoT - Agentic AI Design Patterns]]—extends RAG pattern |
| [[Hybrid Filtering Combines Semantic Search with Hard Logical Constraints]] | 2 | [[Optimization Criteria Must Be Binary Single-Variable Testable Conditions]]—shared mechanism |
| [[Vector Similarity Metrics Serve Different Retrieval Objectives]] | 0 | (none) |
