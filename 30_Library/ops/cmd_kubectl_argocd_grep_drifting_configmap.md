...
tags: [cmd, argocd, drift, configmap, secrets, helm]
---
...
## ✅ Verification
- Expected Output: If the `grep` matches nothing for the old configmap name, it means the workload is already consuming the *new* configuration, and the old ConfigMap is orphaned.

## 💥 Failure Mode Analysis
- **Symptom:** The deploy *does* reference the old configmap!
