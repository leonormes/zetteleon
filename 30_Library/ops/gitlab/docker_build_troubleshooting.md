...
stage: Verify
title: docker_build_troubleshooting
---
...
2. Make sure the CI job has the right Runner tags to use these
   privileged runners.
...
2. Configure your pipeline to install the certificate in the service container before starting the Docker daemon. For example:
