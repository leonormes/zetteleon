...
3. To the right of the runner, you want to edit, select Edit ({{< icon name="pencil" >}}).
4. In the Maximum job timeout field, enter a value in seconds. The minimum value is 600 seconds (10 minutes).
...
3. Expand Runners.
4. To the right of the runner you want to edit, select Edit ({{< icon name="pencil" >}}).
5. In the Maximum job timeout field, enter a value in seconds. The minimum value is 600 seconds (10 minutes). If not defined, the [job timeout for the project](../pipelines/settings.md#set-a-limit-for-how-long-jobs-can-run) is used instead.
...
2. You set the Maximum job timeout for a project to 2 hours.
3. You start a job.
...
2. In the left sidebar, select Settings > CI/CD.
3. Expand Runners.
4. To the right of New project runner, select the vertical ellipsis ({{< icon name="ellipsis_v" >}}).
...
3. Optional. To verify that the previous runner authentication token has been revoked, use the [Runners API](../../api/runners.md#verify-authentication-for-a-registered-runner).
...
1. In the upper-right corner, select Admin.
2. In the left sidebar, select CI/CD > Runners.
3. To the right of the runner you want to protect, select Edit ({{< icon name="pencil" >}}).
...
2. In the left sidebar, select Settings > CI/CD.
3. Expand Runners.
4. To the right of the runner you want to protect, select Edit ({{< icon name="pencil" >}}).
