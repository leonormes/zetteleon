...
3. Use the runner authentication token instead of the registration token when you register
...
2. Replace the registration token in your runner registration workflow with the
