...
severity: p2
tags: [playbook, vso, secrets, troubleshooting]
---
...
*Determine what owns this secret and where it lives in Vault.*
...
*Check if VSO is healthy and has a valid lease.*
...
*Verify what is actually in the cluster.*
...
*Recover from drift or stale credentials.*
