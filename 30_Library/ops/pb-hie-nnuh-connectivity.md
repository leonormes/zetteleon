...
customer: nnuh
status: active
tags: [playbook, network, nnuh, hie]
---
...
2. Run the "Smoking Gun" trace to locate the drop:
   ![[cmd-net-mtr-tcp#⚡ Action]]
   *Expected:* Dies at Hop 11 if Firewall is blocking.

3. Confirm SILENT drop vs REJECT:
   ![[cmd-net-nmap-check-filtered#⚡ Action]]

---

### Phase 2: Destination Infrastructure (Azure Edge)
*Run from local machine or Jumpbox.*
...
*Confirm the app is alive, bypassing the public firewall.*
...
2. Spoof the Host Header (The "Gold Standard" internal test):
   ...
   *Target IP:* Use the internal Ingress Controller IP.
