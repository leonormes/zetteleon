...
Tracked as FTFL-877. Note the same comment asserts _"With 'Pipelines must succeed' now enabled on this project…"_—that assertion is stale; the gate is off. See S-02 in [[FITFILE Audit - Security Findings and Remediation]].
