...
### Current Focus (Year 10)

Per the SoT dashboard: Biology (CIE IGCSE), English Language (AQA), Photography (AQA), and Sociology (AQA) are the live subjects. Maths, English Literature, Art, and Chemistry are parked until Summer 2026. Immediate admin: confirm the exam centre and define the weekly structure review.
...
- Every Bessie note carries the `bessie` tag and `project_name: Bessie` in frontmatter.
- New Bessie notes surface in `Family.base` (via the tag) and the 🎓 Bessie Education section of [[Projects Dashboard]] (via `project_name`).
- This note is the dashboard entry (`type: project`); the thinking lives in the MOC and SoT above.
