...
| Field | Detail |
|---|---|
| Product line | Acer Chromebook Spin 714 |
| Marketing model | `CP714-2WN-36LD` |
| Regulatory model | `N22Q10` |
| Acer part/product code | `NX.KLDEK.001` |
| Serial number | `NXKLDEK00145011D567600` |
| SNID | `45007304676` |
| Manufacturing date | 14 December 2024 |
...
| Area | Detail |
|---|---|
| Processor | 13th Gen Intel Core i3-1315U; 6 cores (2 performance + 4 efficient), 8 threads, up to 4.50 GHz, 10 MB Intel Smart Cache |
| Graphics | Intel UHD Graphics for 13th Gen Intel processors |
| Memory | 8 GB LPDDR4X RAM; soldered |
| Storage | 256 GB M.2 PCIe NVMe SSD |
| Display | 14-inch / 35.6 cm WUXGA 1920 × 1200 IPS touchscreen, 16:10, 60 Hz |
| Form factor | Convertible Chromebook with 360-degree hinge |
| Webcam | 2560 × 1440 video resolution |
| Wireless | Intel Wi-Fi 6E AX211 (`AX211D2W`) and Bluetooth 5.1 or later |
...
- Two performance cores and four efficient cores
- Eight processing threads
- 4.50 GHz maximum performance-core turbo frequency
- 3.30 GHz maximum efficient-core turbo frequency
- 15 W processor base power and up to 55 W maximum turbo power
...
| Role | Entity |
|---|---|
| Manufacturer | Acer Inc., 8F, 88, Sec. 1 Xintai 5th Road, Xizhi, New Taipei City |
