---
aliases: [Analysis Paralysis, The Perfectionism Trap, Fear of Failure]
confidence: 5/5
created: 2025-10-28T09:10:00Z
epistemic:
...
see_also: ["[[SoT - PRODOS - System Failure Modes]]", "[[SoT - ADHD Executive Dysfunction]]"]
source_of_truth: true
status: stable
tags: [cognitive-bias, mindset, psychology, prodos]
...
> **Perfectionism** is a defense mechanism, not a pursuit of quality. It is the refusal to accept any standard short of the ideal, often used to mask a fear of failure or criticism.
>
...
## 2. The Core Mechanism: Fear as a Blocker
...
ADHD brains often lack "graduated" thinking. A project is either **Perfect** (100%) or **Worthless** (0%). Since 100% is impossible, the brain defaults to 0% (inaction).

---

## 3. Manifestations in Work
