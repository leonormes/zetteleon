...
modified: 2026-04-02T11:00:00+01:00
source_of_truth: true
status: evergreen
synthesis-count: 1
tags: [architecture, kubernetes, secrets, vault, vso, type/SoT]
...
2. **Kubernetes CRDs (Desired State):** `VaultStaticSecret` and `VaultDynamicSecret` describe *what* to sync and *how* to authenticate.
...
- **Local Resolution:** By default, VSO resolves `VaultAuth` references within the *same* Kubernetes namespace.
