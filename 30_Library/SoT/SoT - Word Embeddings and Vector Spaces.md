...
see_also: ["[[SoT - LLM Tokenization and Economics]]", "[[MOC - LLM-Augmented Thinking]]"]
status: "permanent"
tags: ["ai", "embeddings", "llm", "vector-math", "machine-learning"]
...
*   *Limitation:* Static. The word "bank" has the same vector regardless of whether the context is financial or geographical.
