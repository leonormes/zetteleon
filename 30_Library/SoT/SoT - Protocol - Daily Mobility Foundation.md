---
aliases: ["Animal Flow Beginner Routine", "Daily Mobility Routine", "The Foundation Protocol"]
confidence: "5/5"
...
source_of_truth: []
status: "stable"
tags: ["action", "mobility", "protocol", "routine"]
title: SoT - Protocol - Daily Mobility Foundation
type: "SoT"
uid: 
updated: 
---
...
> **Goal: "** System Activation, Joint Lubrication, and Connection."
> **Mindset: "** \"Practice,\" not \"Workout.\" Focus on quality and control, not fatigue."

## 2. The Routine (Execution List)
...
- [ ] **Lateral Rocks:** Hands on floor, fingers side-to-side, rock. (30s)
...
| Symptom | Fix |
|:--- |:--- |
| **Wrist Pain** | Grip the floor with fingertips ("Cambered Hand"). |
| **Lower Back Ache** | Engage core. Do not let hips sag or rise too high. Keep knees 1 inch off floor. |
| **Knee Torque** | Ensure you pivot on the **ball of the foot**, lifting the heel to allow rotation. |
