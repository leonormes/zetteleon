...
modified: 2025-12-31T13:00:00+00:00
...
> [!definition] The Physics of Work
...
| :--- | :--- | :--- |
| **Writing** | Outline 10 ideas. | Write 1 paragraph. |
| **Fitness** | Search for a gym. | Do 10 pushups. |
| **Coding** | Read documentation. | Write a failing test. |
| **Sales** | Research 100 leads. | Call 1 lead. |

---

## 2. The Trap: Why We Get Stuck in Motion

Motion is dangerous because it **feels like progress** without the risk of failure. It is procrastination disguised as productivity.

### 2.1 The Psychology of Delay
1.  **Fear of Judgment:** You cannot fail if you are "still preparing." Motion delays the moment of truth.
2.  **Dopamine without Cost:** Planning a project releases dopamine (anticipation) without requiring effort (execution).
3.  **Perfectionism:** The belief that more planning will yield a flawless result. (Reality: Feedback yields a flawless result).

### 2.2 The ADHD Amplifier
...
## 3. Escaping Gravity: The Shift to Action

### 3.1 Define the Next Physical Action
...
When facing a task, strictly categorize it to prevent "churn" (Motion).
1.  **Do:** Execute immediately (< 2 mins).
2.  **Delegate:** Assign to someone/something else.
3.  **Defer:** Schedule for a specific time (Timebox).
4.  **Delete:** Remove it entirely.

---

## 4. Strategic Application (Leadership)
