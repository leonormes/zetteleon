---
aliases: [Keyboard Layers, Keyboard Workflow, Scope by Modifier]
confidence: 5/5
...
status: "stable"
tags: ["hammerspoon", "hotkeys", "keyboard", "neovim", "prodos", "raycast", "workflow"]
...
> [!definition]
> The system is designed so you never have to guess "What key does what?". The **modifier** key determines the **scope** of the action. This creates a predictable, hierarchical, and globally consistent control scheme across all environments.
