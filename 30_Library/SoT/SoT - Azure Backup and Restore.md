---
aliases: [Azure Backup, Azure Restore]
confidence: 4/5
created: 2025-12-21T11:00:00Z
epistemic: synthesis
last_reviewed: 2025-12-21
modified: 2025-12-21T14:57:23Z
purpose: To provide a comprehensive Source of Truth on Azure Backup and Restore strategies, particularly for AKS clusters.
review_interval: 3 months
see_also: ["[[SoT - FITFILE Platform Deployment]]"]
source_of_truth: true
status: stable
tags: [aks, azure, backup, restore, sot]
...
> **Azure Backup** is a cloud-native service for protecting data by backing it up to the Azure cloud. It is designed for both on-premises and cloud-based workloads—such as VMs, files, folders, databases, and applications, including Azure Kubernetes Service (AKS) clusters.
