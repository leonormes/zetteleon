...
modified: 2026-04-05T13:40:00+01:00
status: stable
...
Thinking and Action must exist in a state of mutual refinement, not mutual exclusion. To avoid the traps of **Executive Dysfunction** (Paralysis by Analysis or Impulsive Reaction), we must decouple *Generation* from *Organization* and use physical constraints to force cognitive closure. 
...
- **The Method**: Identify the **Minimum Viable Action (MVA)**.
  ...
  - *Is*: "Write 'Buy one book' on the grocery list."
