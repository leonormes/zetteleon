...
status: stable
trust-level: stable
tags: ["azure", "aks", "networking", "sot", "calico"]
...
- **Pod IPs:** Carved from a non-routable CIDR (e.g., `192.168.0.0/16`) *inside* the cluster fabric.
- **Node IPs:** Carved from the Azure VNet subnet defined above.

*Related Reference:* [[CNI Explained]]
