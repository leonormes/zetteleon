---
alias: ["Helm Refactoring Strategy", "Tesler's Law Application", "Forensic Chart Analysis"]
created: 2026-02-05T00:00:00+00:00
modified: 2026-02-05T00:00:00+00:00
status: stable
tags: ["helm", "refactoring", "protocol", "sot", "architecture"]
...
*Goal: Eliminate the "Boolean Swamp".*
...
- **Action:** Implement a Registry where the chart defines *Requirements* (`mongo_password`) and the user defines *Sources* (`vault_path`).
...
*Goal: Solve "Connectivity Complexity".*
...
*Use this prompt to analyze a legacy chart's complexity distribution.*
...
*Related:* [[Pattern - Helm Chart as a Compiler]]
