...
type: SoT
status: stable
tags: [literature, sociology, dystopia, philosophy]
...
*   **The Bureaucratic Void (Kafka):** Control via Uncertainty. The rules are never revealed (e.g., The Trial). Relevant to modern algorithm bans.
*   **The Vertical Class War (Ballard's High-Rise):** Civilization is a thin veneer. It takes only three missed meals for professionals to revert to tribalism.
*   **Voluntary Ignorance (Fahrenheit 451):** Books aren't banned by the state; they are rejected by the people for being "confusing." (TL;DR culture).

## 3. Why We Watch (The Psychology)
