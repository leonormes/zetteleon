---
tags: [domain/systems-thinking, type/SoT, framework/cynefin]
status: evergreen
trust-level: stable
synthesis-count: 1
...
*   *Example:* A "Retry on Fail" logic is simple (Complicated).
*   *Emergence:* When 10,000 clients retry simultaneously, they create a "Thundering Herd" (Retry Storm) that destroys the system. This behavior exists only in the collective, not the individual script.
