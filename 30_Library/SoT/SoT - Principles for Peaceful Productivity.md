...
modified: 2026-08-04T18:43:53+00:00
...
status: stable
tags: [boundaries, principles, prodos/sot, rules, TheHuman/Mindset, topic/productivity]
title: SoT - Principles for Peaceful Productivity
type: sot
---

> Open threads: [[HEAD - What is the observable tell for bad faith, before I disengage?]] · [[HEAD - Does Tesler's Law generalise beyond software?]] · [[HEAD - Have any of my peaceful-productivity principles actually been tested on me?]]

## Minimum Viable Understanding (MVU)

Ten operating principles for producing work without producing anxiety. Each one is a prescription—a concrete behaviour—and each is grounded in a separate mechanism claim elsewhere in the vault. The set is not a productivity _system_; it is the behavioural surface of [[SoT - Behavioral Architecture]]'s System > Willpower axiom, applied to a day rather than to a task. Its diagnostic half—_why_ conventional productivity effort fails—lives downstream in [[Digital Productivity Paradox]], [[Jevons Paradox of Attention]] and [[Pseudo-productivity Heuristic]], which name this note as their upstream. Read those for the disease; read this for the regimen.
...
<!--content-block-start type="concept" id="ppp-protect-first-hour"-->
...
<!--content-block-start type="concept" id="ppp-cease-futile-argument"-->

### 2. Cease Futile Argumentation
...
<!--content-block-start type="concept" id="ppp-initiate-before-readiness"-->

### 4. Initiate Before Readiness
...
<!--content-block-start type="concept" id="ppp-limit-accessibility"-->

### 5. Limit Personal Accessibility
...
<!--content-block-start type="concept" id="ppp-daily-movement"-->

### 6. Mandatory Daily Movement
...
<!--content-block-start type="concept" id="ppp-depersonalise-reactions"-->

### 7. De-personalise External Reactions
...
<!--content-block-start type="concept" id="ppp-energy-check"-->

### 8. The Energy Check Rule
...
<!--content-block-start type="concept" id="ppp-daily-reset"-->

### 9. The 10-Minute Daily Reset
...
<!--content-block-start type="concept" id="ppp-radical-simplicity"-->
...
- [[SoT - Behavioral Architecture]]—_the abstract parent: all ten principles are environment engineering rather than willpower application._
- [[SoT - Indistractable Model (Focus Management)]]—_supplies the traction/distraction test that Principles 1, 5 and 10 assume but do not define._
- [[MOC - Action Management]]—_the navigation hub this note belongs to; the "How" of Domain 1 in [[Meta MOC - The Core Domains]]._
- [[MOC - Health and Vitality]]—_the biological substrate Principle 6 draws on._
- [[Protocol - Weekly Command Centre]]—_the recurring ritual where Principles 3 and 8 get applied to an actual week._
- [[SoT - Conservation of Complexity]]—_the counterweight to Principle 10; see Tensions._
- [[Objective Scoreboards]]—_downstream atom; the measurement counterpart to the Top-One Priority Rule._
- [[Cognitive Firewalls]]—_downstream atom; the deep/shallow separation Principle 1 instantiates._
- [[Waking up early provides an energizing start to the day]]—_adjacent practice note on the morning window Principle 1 protects._
