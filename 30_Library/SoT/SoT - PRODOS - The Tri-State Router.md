...
see_also: ["[[SoT - PRODOS - Problem-Solution Map]]", "[[SoT - PRODOS (System Architecture)]]"]
source_of_truth: []
status: "stable"
...
**The Tactical Filter:** Use the **[[SoT - Protocol - The 4D Decision Matrix]]** (Do, Delegate, Defer, Delete) to assign the initial fate of each item before routing.
