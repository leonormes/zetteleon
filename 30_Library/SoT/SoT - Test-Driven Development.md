...
"A test is the first user of your code" (*The Pragmatic Programmer*). If a test is difficult to write, the API is difficult to use. TDD forces intuitive interface design by starting from the client's perspective.
