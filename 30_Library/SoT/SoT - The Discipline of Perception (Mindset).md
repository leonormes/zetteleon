---
aliases: ["Mindset for Action", "Stoic Perception", "The Discipline of Perception"]
confidence: "5/5"
...
> **The Discipline of Perception:** The ability to see things as they really are, stripping away the subjective story ("This is bad") from the objective event ("This happened").
> **Core Axiom:** Obstacles are not created by external events, but by how we interpret those events.
...
- **Ignition Protocol:** When stuck, use the **Spite Hack** or **Mystery Hack** to reframe the Perception of the task.
- **Refine Phase:** The "Linting" step in processing the Inbox is purely an exercise in **The Observing Eye**—stripping emotion ("I hate this") to find the signal ("I need to update the CSS").
...
- **[[The Discipline of Perception (Stoicism)]]**
