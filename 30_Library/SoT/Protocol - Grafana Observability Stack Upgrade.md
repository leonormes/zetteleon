---
alias: ["Grafana Migration Protocol", "Alloy Operator Upgrade Guide"]
created: 2026-02-05T00:00:00+00:00
modified: 2026-02-05T15:40:32+00:00
status: stable
tags: ["grafana", "observability", "helm", "protocol", "migration"]
...
*Fix the broken update path by switching to OCI.*
...
*Helm often fails to upgrade CRDs automatically. Install them manually first.*
...
*Translate v1 logic to the v3 schema. Do not reuse the old `values.yaml`.*
...
*For air-gapped or private ACR setups, import these specific images:*
...
2. **Verify Collectors:**
   ...
   *(Should list `alloy-metrics`, `alloy-logs`, etc.)*
