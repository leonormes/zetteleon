...
modified: 2026-02-06T09:00:00+00:00
tags:
...
- **The Hybrid Loop:** The agent queries the graph for structure first, then loads *only* the specific node's text into the context window, minimizing noise. See [[SoT - Recursive Language Models]].
...
4.  **Comments as System Prompts:** Docstrings should define *Invariants* and *Intent*.
