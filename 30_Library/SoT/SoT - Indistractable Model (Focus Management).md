...
Focus is not the absence of distraction, but the management of **Triggers** (Internal/External) and the commitment to **Traction**. Productivity is fundamentally **Pain Management**—the ability to handle the discomfort that prompts the urge to escape.

---

### 2. The Four Pillars of Focus
...
- **Finitude:** Distraction is an attempt to flee the painful confrontation with our limited time and control (Oliver Burkeman).
...
3. **Identity Pacts:** Change your self-image to align with behavior (e.g., "I am indistractable"). Replace "I have to" with "I choose to."

---

### 3. Implementation in ProdOS

- **Capture:** All triggers go to `00_Inbox` or `Daily Note`.
- **Clarify:** Determine if the trigger is Internal (needs Pain Management) or External (needs Hacking Back).
- **Execute:** Use **Timeboxing** and **Pacts** to ensure Traction.
- **Review:** Weekly Hansei checks if pacts are holding or if environment needs re-engineering.
