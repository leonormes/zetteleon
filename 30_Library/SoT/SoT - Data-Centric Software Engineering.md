---
aliases: [Data-Centric Design SoT, Data-First Programming, Software Engineering SoT]
confidence: 5/5
created: 2025-12-22T12:00:00Z
epistemic: architecture
last_reviewed: 2025-12-22
modified: 2025-12-22T11:07:50Z
purpose: To define the principles of Data-Centric Software Engineering, prioritizing state representation over procedural logic.
review_interval: 6 months
see_also: ["[[MOC - Data-Centric Networking]]", "[[SoT - Data-Centric Infrastructure (Terraform)]]"]
source_of_truth: true
status: stable
tags: [architecture, data-centric, software-engineering, sot]
...
> **Data-Centric Software Engineering** is the practice of designing systems by first defining the **State** (Data Structures) and **Constraints** (Invariants), treating **Logic** (Algorithms) as a secondary consequence of the data layout.
>
