...
### 2.1 Abstraction Layer: Decoupling
...
## 3. The Vector of Allocation

Spending is not a Scalar quantity (Amount); it is a **Vector** quantity (Amount + Direction).
...
## 4. Money as an API (The Scheduler)
...
## 5. Total Cost of Employment (The Overhead)
