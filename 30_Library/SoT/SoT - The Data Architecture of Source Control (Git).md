---
aliases: [Git Data Architecture, Merkle DAG Source Control, SCM Theory, SoT - Git Architecture]
confidence: 5/5
created: 2025-02-07T12:57:52Z
epistemic: architecture
last_reviewed: 2025-12-22
modified: 2025-12-22T11:07:55Z
purpose: To define the fundamental data architecture of Git-based source control, focusing on state representation and DAG topology.
review_interval: 6 months
see_also: ["[[SoT - Git]]", "[[SoT - Main-as-Default Trunk Based Development]]"]
source_of_truth: true
status: stable
tags: [architecture, data-centric, git, sdlc, sot]
...
> **Git** is a **content-addressable, persistent data store** that utilizes a **Directed Acyclic Graph (DAG)** to model the evolution of a filesystem state.
>
> From a data-centric perspective, Git is not a "version control tool" but a **Merkle DAG** of immutable objects. The logic of branching, merging, and tracking history is a "degenerate" consequence of the graph's topology and the immutability of its nodes.
