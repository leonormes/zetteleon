...
> The **Data-Impact-Proposal-Check** framework is a four-step communication algorithm for setting boundaries or correcting expectations in a non-confrontational, Adult-to-Adult manner. It shifts the conversation from subjective feelings to objective, systemic consequences and collaborative solutions.

## 2. The Four-Step Algorithm

This flow provides a script for turning a potential conflict into a structured negotiation.

### Step 1: Data (The Situation)
...
Validate the agreement to ensure alignment and close the loop.

- **Effective (Adult):** "Are you aligned with that workflow, or would you like to adjust it?"

This framework makes the conversation about improving a shared system, not about personal complaints, making it a powerful tool for assertiveness.
