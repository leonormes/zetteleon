---
aliases: [Universal Approximation Theorem, Neural Network Foundations, The Switch-Bump-Staircase Model]
created: 2026-04-05T12:45:00+01:00
modified: 2026-04-05T12:45:00+01:00
status: stable
...
While the theorem proves a solution *exists*, it does not guarantee that standard training algorithms (like gradient descent) will find it, nor does it imply that a single-layer "wide" network is more efficient than a "deep" multi-layered one.
...
| :--- | :--- | :--- |
| **Trainability** | The theorem proves a configuration *exists*. | It does not guarantee that backpropagation or gradient descent can *find* that configuration in a complex optimization landscape. |
