...
modified: 2026-04-02T10:15:00+00:00
source_of_truth: true
status: evergreen
synthesis-count: 1
tags: [ohdsi, synthetic-data, ehr, simulation, type/SoT]
...
The *Publicly Available Data Approach to the Realistic Synthetic EHR* (PADARSER) assumes access to real records is impossible. It ensures absolute privacy by building simulations entirely from:
...
- **Transition Logic:** 
    ...
    - *Distributed:* Probabilistic paths based on percentage distributions.
    - *Conditional:* Attribute-based branching (e.g., "If Age > 50").
