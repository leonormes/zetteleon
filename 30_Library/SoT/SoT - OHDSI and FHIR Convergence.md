---
aliases: ["OMOP on FHIR", "FHIR Facade", "Vulcan Accelerator"]
confidence: "High"
created: 2026-01-06T19:30:40+00:00
epistemic: "Integration"
last_reviewed: 
modified: 2026-01-06T19:35:01+00:00
...
> -  **FHIR:** Optimized for **Exchange** and **Transactional** access (OLTP). Moving data *between* systems (EHR to App).
> -   **OMOP:** Optimized for **Analytics** and **Population** queries (OLAP). Asking questions *across* the system.
...
- **Mechanism:**
    - *Request:* `GET /Patient/123` (FHIR).
    - *Translation:* Query `SELECT * FROM person WHERE person_id = 123`.
    - *Response:* Map columns to FHIR JSON and return.
