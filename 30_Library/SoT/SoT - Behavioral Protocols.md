...
- **Habit Stacking:** "After I [Brush Teeth], I will [Meditate 1 min]."
...
- _Rule:_ Keep the Cue and Reward the same.
- _Swap:_ Cue (Stress) -> Routine (Doomscroll) -> Reward (Calm) BECOMES Cue (Stress) -> Routine (Box Breathing) -> Reward (Calm).
