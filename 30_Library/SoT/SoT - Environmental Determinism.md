...
- **Analysis:**
    - **In Vietnam ($E_1$):** High stress, easy access, peer usage = Addiction.
    - **In USA ($E_2$):** No cues, different peers, different context = Cessation.
    - Unlike standard rehab (where patients return to the same environment), the soldiers experienced a total environmental reset.

**Conclusion:** Change the pipes (Environment), and you change the flow (Behavior), regardless of the fluid (Person).
