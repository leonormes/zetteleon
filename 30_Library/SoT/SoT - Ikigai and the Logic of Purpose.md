...
The concept of Ikigai has been popularized in two distinct forms:
...
-   **The Mental Model:** Do not seek a "perfect self" or a "completed legacy" immediately. View progress as adding "thin sheets of paper one by one."
-   **The Algorithm:**
    1.  **Zoom In:** Focus on the granular quality of the immediate action.
    2.  **Reject Latency:** Do not wait for the "Big Win" to feel purpose. Find the "Small Joy" in the current step.
    3.  **Low-Latency Feedback Loop:** This immediate gratification prevents burnout, unlike the high-latency feedback of chasing status or wealth.
