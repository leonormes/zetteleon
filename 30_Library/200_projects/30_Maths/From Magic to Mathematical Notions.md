...
Many people dislike mathematics, often recalling it as a subject of rote memorisation, like "drill and kill" methods for times tables or following steps to solve algebra problems, which has little to do with the creative thinking mathematicians do. However, the core of mathematical thinking, as exemplified by Gauss's insight, is about discerning the deeper structure and logic behind phenomena.
...
Despite these limits to absolute certainty, the pursuit of proof compels mathematicians to focus on the underlying "notions" and the precise logical deductions from foundational "axioms" (accepted assumptions). Just as Pythagoras's theorem can be understood through a simple visual proof that reveals the relationship between areas (a "notion"), rather than complex calculations, so too do other mathematical concepts become clearer when their core ideas are grasped.

In summary, Gauss's assertion that "notions, not notations" matter in mathematics is a directive to seek the fundamental ideas and logical structures that govern mathematical phenomena. Party tricks serve as accessible illustrations of this principle, showing how algebra provides the "notion" (the general rule or cancellation) and how proof offers the ultimate "guarantee" of its universal applicability, moving beyond mere observation of the "notation" (the specific numbers or symbols). This intellectual journey from specific observations to general, provable truths is at the heart of mathematical thinking.

Next step: To deepen our understanding of "notions," we could explore specific examples of how abstract mathematical concepts, such as group theory (mentioned briefly as an "algebra of symmetry"), reveal unexpected unities across different natural phenomena, further illustrating the power of understanding underlying structures.
