...
## [kubernetes/ingress-nginx](https://github.com/kubernetes/ingress-nginx)[](https://argo-cd.readthedocs.io/en/stable/operator-manual/ingress/#kubernetesingress-nginx "Permanent link")
...
In order to expose the Argo CD API server with a single ingress rule and hostname, the `nginx.ingress.kubernetes.io/ssl-passthrough` [annotation](https://kubernetes.github.io/ingress-nginx/user-guide/nginx-configuration/annotations/#ssl-passthrough) must be used to passthrough TLS connections and terminate TLS at the Argo CD API server.
...
## [Traefik (v3.0)](https://docs.traefik.io/)[](https://argo-cd.readthedocs.io/en/stable/operator-manual/ingress/#traefik-v30 "Permanent link")
...
## [Istio](https://www.istio.io/)[](https://argo-cd.readthedocs.io/en/stable/operator-manual/ingress/#istio "Permanent link")
