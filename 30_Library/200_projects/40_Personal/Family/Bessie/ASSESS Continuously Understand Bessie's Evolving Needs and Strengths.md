...
title: "ASSESS Continuously Understand Bessie's Evolving Needs and Strengths"
type: ""
uid: 
updated: 
version: ""
...
The 'Assess' stage involves gathering comprehensive and holistic information about Bessie's learning profile, which should be an ongoing process.
...
- [[Adhd 2.0]] - Understanding Task-Positive Network (TPN) vs Default Mode Network (DMN) patterns: "What three or four things are you best at doing? What three or four things do you like doing the most?"
- [[Solving the Procrastination Puzzle]] - Assessing executive function patterns and self-deception tendencies

### Learning Strategy Assessment

- [[Learn Like a Pro]] - Evaluating current study habits and identifying areas for process-focused improvements
- [[I learned a system for remembering everything]] - Assessing note-taking and information retention methods

### Systemic Context

- [['I've been fighting for so long' More than half of special needs plans delayed]] - Understanding the broader challenges facing SEND families and ensuring Bessie's assessment doesn't get delayed
...
- How can her creative strengths be channeled to develop other character virtues?
- What character strengths emerge when she feels safe and supported?
