...
- [[Learn Like a Pro]] - External working memory strategies: "Putting a key word, number, or formula on paper extends your working memory to the paper"
- [[I learned a system for remembering everything]] - Note-taking systems that create an "exterior brain" for organizing information

### ADHD-Aware Teaching Approaches

- [[Adhd 2.0]] - Understanding Task-Positive Network (TPN) engagement and avoiding Default Mode Network (DMN) traps
- [[Solving the Procrastination Puzzle]] - Implementation intentions for task initiation across all subjects
