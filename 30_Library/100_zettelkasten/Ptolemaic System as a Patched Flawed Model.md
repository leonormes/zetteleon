...
- [[Flawed Mental Models Limit Mastery]]—concrete historical instance of that note's "Bug in the Model" pattern: a flawed foundational assumption that stays hidden because the patched model remains predictive within known parameters.

[supports:: [[Kuhn's Four-Stage Model of Paradigm Collapse]], confidence=high]

- [[Kuhn's Four-Stage Model of Paradigm Collapse]]—the canonical example of that model's Model Drift stage: anomalies (planetary retrograde motion) patched with epicycles rather than the core geocentric assumption being questioned.
