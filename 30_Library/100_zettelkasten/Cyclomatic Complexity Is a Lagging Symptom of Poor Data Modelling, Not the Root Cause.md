...
- [[SoT - LLM Codebase Understanding & Hierarchy]]—*its CFG layer ("The Graph", §ii) is explicitly named as what cyclomatic complexity is calculated from; this note supplies the McCabe-vs-Chapin metric distinction that layer presupposes but doesn't unpack.*
