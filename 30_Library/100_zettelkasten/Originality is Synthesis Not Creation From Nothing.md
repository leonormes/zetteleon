...
The corollary that matters practically: originality cannot be pursued directly. It is a *residue* of a filtering process — what remains after your specific experience selects, arranges and discards. Trying to be original by avoiding influence removes the very material synthesis operates on.
...
- *Everything is a Remix* (Ferguson)—_A sibling framing of the same claim: all creative work proceeds by copying, transforming and combining. **No note exists for this yet** — the old link was dangling, so it is de-linked here rather than left broken._
