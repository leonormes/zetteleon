...
- The Hook (Draw Hand):
  - Hook Consistency: Executing the _exact same hook_ on every single arrow is more critical than the specific depth you use.
  ...
  - Hook as One Unit: The index, middle, and ring fingers must act together as a single, relaxed unit. Avoid bulging knuckles or an angled wrist joint.
  - Avoid Over-Tensing: Do not apply excess finger pressure (e.g. using 20 kg of muscle force to hold a 15 kg bow). Excess tension forces you to use extensor muscles to claw your hand open upon release, ruining release consistency.
  - Hook Depth (First Joint Sweet Spot):
    - _Skeletal Alignment_: Setting a deep hook (close to the joint lines) places the string nearer to the skeletal line of force, allowing you to hold full draw weight with far less physical muscular exertion compared to fingertip hooks.
    - _Avoid Too Deep (Second Joint)_: Placing the string past the first knuckle (towards the second joint) makes a clean release impossible, forcing you to uncurl two entire finger digits and leading to wide, splayed arrow flights.
    - _Avoid Too Shallow (Fingertips)_: Hooking on the very fingertips introduces massive isometric tension on sensitive skin pads. Fingertip hooks deflect the string twice as much because tense muscles cannot relax quickly, leading to sideways plucking.
    - _The Sweet Spot_: Position the string directly in the first groove of your index finger, in or slightly behind the groove on your middle finger, and on the pad (slightly in front of the groove) of your ring finger.
  - A Slipping Hook: If your fingers fail to maintain a deep hook and begin to slip on the string, the sudden loss of tension will immediately encourage your draw elbow to collapse forward, destroying your expansion and alignment.
  - Straight vs. Slanted Hook: Fingers do not need to sit perfectly perpendicular to the bowstring. A slanted/diagonal hook naturally crosses near the first joint of the index finger, deeper past the middle finger joint, and across the pad of the ring finger.
  - Wrist Relaxation (Flat Back of Hand): Relax your wrist so the bowstring stretches your hand flat as you draw. A clenched hand or tensed wrist creates raised knuckles, which can flick the arrow off the rest.
  - Parallel Fingers & Finger Spacers: Keep fingers parallel on the string to avoid squeezing or pinching the arrow nock. Use a tab with a solid finger spacer to prevent string angles at full draw from compressing your fingers and pinching the nock.
  - Weight Distribution Nuance:
