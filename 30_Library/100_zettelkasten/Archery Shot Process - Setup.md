...
modified: 2026-09-21T16:04:39+01:00
...
#### Set Position Repeats Drill

- Purpose: Builds muscle memory for the set position without wearing you out.
- How to do it: Repeatedly lift the bow from your leg or foot into the set position, establish connection, and bring it back down without drawing the bow.

#### Band Drill (Set Position)

- Purpose: Tests spatial awareness and positioning.
- How to do it: Practice getting into your set position using a resistance band or empty hands to verify correct alignment of hands and shoulders.

#### On/Off Shooting Line Drill

- Purpose: Tests discipline and consistency in stance and set position.
- How to do it: Step onto the line, set up, and shoot a single arrow, then step completely off the line. Reset your stance and set position from scratch for every single arrow.
...
- What Grip Angle is Best for Archery? | Testing 4 Wrist Heights (Jake Kaminski)
