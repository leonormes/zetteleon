...
- [[The Done State as a Boundary for ADHD Projects]]—_The worked example turns "get my head around CNI usage" into "a two-page comparison document of CNI options"._
...
- [[Action Triggers Bridge the Gap Between Motion and Action]]—_A pre-defined rule, such as "after I have researched one solution for 15 minutes, I will start implementing", is a boundary that stops the preparatory phase extending indefinitely._
...
- [[The Hemingway Technique - End Work With Unfinished Problems]]—_Deliberately ending a session on an unfinished sentence or problem._
...
- [[Outcome-Goal Systems Cause Motivational Decay - Process Milestones Sustain Engagement]]—_Add milestones so reward does not wait until the end of a long project._

Failure modes:

- Writing the done state as an activity ("work on the report") rather than a checkable result, so it can never be reached.
- Setting the criteria after you have started, when polishing has already begun to feel necessary.
- Compound criteria that can be half met, which invite endless "one more pass".

## Managing Perfectionism

Perfectionism is the main reason a done state keeps moving, so the strategies above need a specific guard for it.

- [[SoT - Perfectionism and Analysis Paralysis]]—_Describes the all-or-nothing distortion: a project is either 100% or worthless, and because 100% is impossible the brain defaults to inaction. A fixed, small done state replaces that scale._
- [[Claim - ADHD perfectionism is maladaptive compensation]]—_The pattern often comes from an attempt to compensate for a history of underachievement, so an unreachable ideal reliably produces shortfall, self-criticism and a hunt for a better system. Its own counter-position is that the standards are not the problem; rigid all-or-nothing scoring is._
- [[Perfectionism's Harm Comes From Contingent Self-Worth and Fear of Failure, Not High Standards Alone]]—_The useful lever is the fear layer under the standard, so set the done state at what the purpose needs and treat an error as information, not a verdict._
- [[Satisficing Leads to Sub-optimal Solutions]]—_A tension worth holding: "good enough" can lock in the first adequate option. Tie the criteria to the purpose of the work, not to whatever is first available._
- [[The Danger of Perpetual System-Building]]—_Perfecting the design instead of using the simplest workable version is this failure in productivity systems._
- [[The Core Problem Confusing Preparation with Action]]—_Planning and preparing can be avoidance dressed as diligence; this note is the section it points to for the fix._
- [[MOC - Three-Phase Protocol for Execution]]—_Where the perfectionism-neutralising and aggressive-initiation phases sit in the wider execution protocol._

## Related

- [[Process Over Outcome Mindset]]—_Counters perfectionism by valuing the process, so an incomplete project counts as a learning experience rather than a failure; it balances the concrete done state rather than replacing it._
- [[Rejection-Sensitive Dysphoria]]—_Often the emotional driver behind the fear layer in Managing Perfectionism._
...
- [Start Now. Get Perfect Later. — Rob Moore, Section 2 "The pain & paradox of perfection", pp. 23-24](calibre://view-book/GCcalibreBooks/692/EPUB)—_You can never have all your ducks in a row before you start, and the pain of perfectionism comes from fear rather than strength; strive for excellence, not perfection._
- [Getting Things Done — David Allen, "How Much Planning Do You Really Need to Do?", p. 117](calibre://view-book/GCcalibreBooks/1608/EPUB)—_A stopping rule for planning: do as much as you need to get the project off your mind, which for most projects is just the outcome and a next action._
