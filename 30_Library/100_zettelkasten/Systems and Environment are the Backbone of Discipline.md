...
tags: [discipline, environment, TheHuman/Motivation, tombstone, topic/systems]
...
> This claim and [[Discipline Is a Property of External Structure More Than of Will]] were the same proposition reached from two directions—this one from the _motivation_ side ("motivation is fleeting, so design systems"), the survivor from the _willpower_ side ("willpower is insufficient, so use external supports"). The survivor carried more backlinks and the broader scope, so it absorbed this note.
