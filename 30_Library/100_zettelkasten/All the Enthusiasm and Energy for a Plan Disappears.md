...
- [extends:: [[Claim - Novelty-craving drives self-defeating system-hopping]]] — _Same root mechanism (the novelty-adoption dopamine burst decays before the system matures), narrowed to a specific design implication: this note says the surviving system must be simple, where that note focuses on the hopping-between-systems behaviour the same burst produces._
...
- [[Dopamine Management in ADHD Productivity]] — _The broader dopamine-driven-motivation framework this note's specific crash-and-collapse pattern is one instance of._
- [[ADHD Brain Wiring vs. Classic Productivity Systems]] — _The wider conflict (linear productivity systems vs. interest-driven ADHD wiring) that makes "stupidly simple" the only design that survives._
