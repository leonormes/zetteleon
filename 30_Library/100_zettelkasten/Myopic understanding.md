...
> What this note is. A seed capture from 2025-07-26 that was subsequently atomised. Every proposition below now lives in its own note; this page's remaining job is to hold them in the order that makes them an _argument_ rather than a list. Six notes backlink here, so it stays at this path.
