...
- Debugging: Debugging is fundamentally a process of identifying and correcting discrepancies between a developer's mental model of how the code *should* work and its actual runtime behavior. When a bug occurs, it signals an error or incompleteness in the developer's current mental model.
