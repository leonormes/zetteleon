...
For Deutsch, the absolute core of the scientific method is the quest for good explanations. A "good explanation" is an assertion about reality that is hard to vary—meaning its details play a highly specific, functional role in the explanation and cannot be easily swapped out.

### Scope & Conditions

Deutsch's core criterion for scientific quality; intended to replace predictive success or bare falsifiability as the primary target of a good theory.

### Evidence

> "A 'good explanation' is an assertion about reality that is hard to vary—meaning its details play a highly specific, functional role in the explanation and cannot be easily swapped out"

### Implications

- Gives a concrete test for genuinely explanatory (realist) depth, beyond simply wanting to understand mechanics.
- Distinguishes a theory that explains from one that merely fits the data, relevant wherever multiple theories fit the same evidence.

### Related

[extends:: [[Instrumentalism vs Realism in Understanding]], confidence=high]

- [[Instrumentalism vs Realism in Understanding]]—that note distinguishes realism from instrumentalism only by stated aim ("wanting to understand the actual mechanics"); this note supplies Deutsch's concrete, checkable criterion for what a realist explanation must look like.
- [[A Scientific Theory Is a Well-Tested Explanatory Framework Not a Promoted Hypothesis]]—sharpens what "well-tested explanatory framework" should mean: not just repeatedly-surviving-tests, but structurally hard-to-vary.
- [[Underdetermination Means Multiple Theories Can Fit the Same Evidence]]—gives a tiebreaker for that note's open question of what, beyond fit-to-data, should decide between underdetermined theories.
- [[Deutsch Rejects Instrumentalism Because Prediction Is a Means, Not the Purpose, of Science]]—this concept is the positive criterion behind that claim's rejection of instrumentalism.
