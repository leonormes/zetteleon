...
Describes the epistemic difficulty of categorisation from an outside observer's perspective, not a claim that the underlying causes are themselves fuzzy or a matter of degree. Framed around ADHD/executive-function examples because that's where this vault has done the most direct work, but the same structure applies to autism, dyslexia, and other neurodevelopmental conditions read as character failings.
...
- [[Misinterpretation as Character Flaws]]—_the interpersonal instance this note generalises: ADHD symptoms specifically, read as character flaws by teachers and family._ [extends:: [[Misinterpretation as Character Flaws]], strength=3, confidence=medium]
- [[Reframe Habit Setbacks as Capacity Limits Not Character Flaws]]—_the corrective this categorical ambiguity justifies: treat capacity limits as capacity limits, not moral failings, precisely because you can't tell from outside which one you're looking at._ [supports:: [[Reframe Habit Setbacks as Capacity Limits Not Character Flaws]], strength=3, confidence=medium]
- [[ADHD Task-Paralysis Reflects DMN-FPN Maturational Lag, Not Willpower Failure]]—_the neurological instance: direct fMRI evidence resolving one specific case of this ambiguity in favour of neurology, not character._
- [[MOC - Character and Virtue]]—_§6 "The Counterweight" is this vault's whole cluster of notes pushing back against reading capacity limits as character defects; this note supplies the general epistemic mechanism behind why that section exists._
- [[Vague Boundaries]]—_the general phenomenon this is an instance of: no principled line visible from outside, even though—unlike a true continuum case—there is a fact of the matter underneath it._ [depends_on:: [[Vague Boundaries]], strength=3, confidence=medium]
