...
Many challenges our ancestors faced—hunting large game, defending against predators—were impossible to solve alone. Cooperation allows groups to pool cognitive and physical resources to achieve goals none could manage individually.

This social environment created an evolutionary feedback loop: as society became more complex, it selected for individuals with better social intelligence (communication, empathy, theory of mind), which enabled even more complex societies.

## Records as the Ratchet of Progress

Precise records act like a mechanical ratchet, allowing movement in only one direction. Once knowledge is written down, it becomes stable and can no longer be easily forgotten or distorted through retelling.
...
Links: [[Mirror Neuron System Enables Model Sharing]], [[Mental Models as Social Status Signals]]
