...
[depends_on:: [[Eufriction - Productive Friction Strengthens Thinking]], strength=4, confidence=high]

- [[Eufriction - Productive Friction Strengthens Thinking]]—_this claim's "friction enables mastery" insight rests on the same premise this vault's own axiom establishes: difficulty and resistance are generative, not merely obstacles to be automated away._
...
- [[Modern Work Environments are Typically Wicked]]—_context for why "meaningful work" keeps generating problems in the first place: wicked environments demand constant novel problem-solving rather than the application of settled, stable rules._
