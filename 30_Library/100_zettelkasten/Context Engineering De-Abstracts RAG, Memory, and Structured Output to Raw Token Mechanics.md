...
title: Context Engineering De-Abstracts RAG, Memory, and Structured Output to Raw
  Token Mechanics
type: claim
...
- **It grounds this vault's existing context-management notes in a common mechanism**: [[SoT - Context Engineering]] and [[SoT - Context Rot]] already treat context engineering substantively (compression over accumulation, information density); this note adds the explicit definitional claim about *what context engineering fundamentally is*, relative to the higher-level techniques built on top of it.
