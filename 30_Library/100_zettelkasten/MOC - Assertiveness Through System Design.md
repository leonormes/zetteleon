...
> **Assertiveness Through System Design** is a mental model that reframes professional assertiveness from a personal, confrontational act into a structural problem of **interface management**. It advocates for defining clear "APIs" (rules of engagement) with colleagues and managers to handle boundaries, expectations, and scope with logic rather than emotion.

This Map of Contents (MOC) organizes the core frameworks and tactical protocols for implementing this system.
