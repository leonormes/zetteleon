...
- topic/critique
proposition: The trending term "loop engineering" is not a genuinely new engineering
  discipline — it is a hype-driven rebrand of standard software development life cycle
  (SDLC) concepts (plan, execute, validate, iterate) that already existed before agentic
  AI. "AI Developer Workflow" and "software factory" are more accurate framings for
...
This is a framing/terminology argument, held at low epistemic status accordingly — it's a normative claim about how a term *should* be understood rather than an empirical or mechanistic claim. Reasonable disagreement exists: proponents of "loop engineering" as a term might argue the *degree* of automation and the specific role of validation loops is different enough in kind, not just degree, to warrant a distinct name.
