...
- Freezing completely causes muscles to fatigue against the bow weight, causing you to lose draw length (creep), lose tension, and likely pluck or collapse.
- Shifting your internal focus away from how to get to full draw and solely onto how you are expanding blocks out negative thoughts.
- A dynamic, firm, aggressive release with strong elbow continuation pulls firmly into the face, preventing early collapse.
...
- How to do it:
  ...
  2. Draw vertical reference lines along the front of your nose, forehead, and the back of your head at full draw.
  3. Scrub the video timeline back and forth between full draw and the release.
...
#### LAN2 Blank Bale Focus

- Purpose: Trains LAN2-led expansion through the clicker without the distraction of aiming.
- How to do it:
  1. Shoot at a blank bale from 3 to 5 yards.
  2. At full draw, put 100% of your mental focus on moving LAN2 backward and around your spine in a small rotational arc, and let that movement pull the arrow through the clicker.
...
- KSL / NTS LAN2 drill summary (captured 2026-09-21; underlying source notes not named): LAN2 Blank Bale Focus
- KSL / NTS aiming and timing summary (captured 2026-09-21; underlying source notes not named): California roll, brick wall cue, string drift, competition timing
- Total Archery: Inside the Archer (Kisik Lee & Tyler Benner), Ch. 17 Expansion (clicker distance) and Ch. 23-24 aiming and timing (PDF pp. 219-227); read from an OCR of the scanned PDF, 2026-09-21
