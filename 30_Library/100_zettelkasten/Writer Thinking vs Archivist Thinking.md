...
tags: [organization, TheHuman/Mindset, topic/knowledge-architecture, topic/pkm, topic/pkm/zettelkasten]
...
Summary: Archivist thinking asks "Under which topic do I store this?" (optimizing for retrieval). Writer thinking asks "In which context will I want to stumble upon this again?" (optimizing for discovery and connection).
