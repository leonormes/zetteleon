...
status: stable
tags: [social-dynamics, SoftwareEngineering/Architecture, topic/systems]
...
> Socio-Technical Dissonance describes a state where a system's Control Plane (the social hierarchy, management, and team dynamics) is misaligned with its Data Plane (the technical reality, domain expertise, and execution). This misalignment causes the system (the team or organization) to burn significant energy on internal friction rather than productive output.

This Map of Contents (MOC) organizes the core concepts that define and explain the causes and effects of this dissonance.

---

## 2. Core Concepts & Related SoTs
...
- [[SoT - Epistemic Trespassing and the HiPPO Effect]]
  - These concepts explain _why_ unqualified authorities (the Highest Paid Person's Opinion) override qualified experts, leading to flawed decisions.
