...
> [!definition] The Interpretation Dependency
> Symbols require interpreters to become meaningful.
> A unique identifier (UID) or reference is inert data until it is processed by an interpretation layer that resolves its context and intent.

This MOC maps the critical bridge between Abstraction (The Symbol) and Reality (The Meaning).
