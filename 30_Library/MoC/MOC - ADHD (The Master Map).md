...
ADHD is not a "deficit of attention," but a Resource Management Failure. It is the biological inability to self-regulate focus, arousal, and effort based on abstract "Importance." This hub serves as the central entry point for understanding the ADHD brain and the external scaffolding required to thrive.

---

## 1. The Hardware: Neurology & Core Concepts
...
- The Paradox: [[Russell's Paradox in Naive Set Theory]] (Metaphorical)—_Why "trying harder" within a broken system only creates more friction._

---

## 2. The Software: Emotional Regulation & Mindset

_Managing the "Software Glitches" of Shame, RSD, and Overwhelm._

- The Reset: [[SoT - The 3-Switch Protocol (Emotional Reset)]]—_A 15-second physical override for emotional flooding (Face, Label, Micro-win)._
...
## 3. The Operating System: Executive Function & Physiology

_The mechanics of how work (and failure) happens._

- The Bottleneck: [[SoT - Working Memory & Schema Theory]]—_Why we need [[SoT - The Extended Mind]] to offload cognitive load._
- The Execution Chain: [[SoT - The Cognitive Physiology of Task Execution]]—_The 5 phases of action and where they break for ADHD._
- The Continuity Gap: [[MOC - ADHD Project Continuation Challenge]]—_Scaffolding the "Mental Model Dissipation" when returning to work._
- The Perception: [[SoT - The Nature of Time and Perception]]—_Deep dive into "Now vs. Not Now" and Time Agnosia._

---

## 4. The Protocols: Management & Interventions
