...
What you're experiencing is a very common, yet often misunderstood, pattern for people with ADHD. It's incredibly frustrating to feel like you're on a constant rollercoaster of intense engagement followed by a complete mental void. [[ADHD Brain Constantly Scans for Dopamine-Rewarding Stimuli]] `rel:: defines` this pattern—a powerful and consuming wave of interest that is neurological in origin, driven by the unique wiring of the ADHD brain.

This entire process can be best understood not as a personal failing, but as your brain's powerful, albeit erratic, search for stimulation and reward. [[The ADHD nervous system is primarily interest-driven]] `rel:: underlies` the entire cycle, creating the fundamental drive that powers each phase.

### The Anatomy of the ADHD Interest Cycle

#### Phase 1: The Spark and the Slow Burn (The Search for Dopamine)

This is where it all begins. [[The ADHD Brain as a High-Performance Engine with a Faulty Transmission]] `rel:: initiates` the cycle. Your brain, which has a different dopamine regulation system, is constantly scanning the environment for something that will provide a sense of reward and stimulation. This isn't a conscious choice; it's a fundamental drive.
...
This is the peak of the cycle. Your growing interest has now blossomed into [[Hyperfocus is a State of Intense Interest-Driven Focus in ADHD]] `rel:: characterizes` this phase—not just regular interest, but an intense, all-consuming state of concentration.
...
- [[Novelty Fading Causes Dopamine Reward to Diminish in ADHD]] `rel:: triggers-crash`—[[Dopamine Management in ADHD Productivity]] `rel:: explains`, and once you've explored the most exciting parts, the dopamine reward diminishes significantly.
...
- [[The Neuroenergetic Deficit Theory Posits Chronic Energy Insufficiency in ADHD Brains]] `rel:: causes` the mental emptiness—having come down from the high of hyperfixation, your brain is now in a dopamine deficit.
...
Recognizing this as a core trait of your ADHD, rather than a personal flaw, can help you approach solutions with more self-compassion and strategy. [[How to Build Neurodivergent-Friendly Routines]] `rel:: strategy` provides the solution: building novelty and flexibility _into_ your systems rather than expecting your brain to maintain interest in static routines.
...
- [[SoT - ADHD Neurology & Core Concepts]] `rel:: see-also`—Broader context for ADHD motivation patterns
- [[Dopamine Management in ADHD Productivity]] `rel:: see-also`—Practical strategies for working with dopamine-driven motivation
- [[SoT - ADHD Self-Compassion & Strengths]] `rel:: see-also` - For dealing with the shame of the crash.
