---
aliases: ["Linux Networking MOC", "Container Networking Map"]
confidence: "High"
...
source_of_truth: []
status: "Active"
tags: ["moc", "linux", "networking", "containers"]
title: MoC - Linux Networking
type: "MoC"
uid: 
updated: 
---
...
*   **[[SoT - Linux Networking Primitives]]:** The definitive guide to Veth Pairs, Bridges, and Namespaces.
    *   *Key Concept:* **Namespaces** isolate the stack; **Veth Pairs** tunnel through the isolation; **Bridges** switch traffic between them.
