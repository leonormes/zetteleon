...
- [[Protocol - Typed Answer Contract (TAC) for Vault Agents]]—_Governs how agents _working in this vault specifically_ must format output; a PKM-governance protocol rather than a claim about agentic AI in general._
