# What a "proposition" Actually is
...
[A proposition is a declarative claim that bears a truth value.md](A%20proposition%20is%20a%20declarative%20claim%20that%20bears%20a%20truth%20value.md)

[2. The case FOR the Claim.md](2.%20The%20case%20FOR%20the%20Claim.md)

[2a. The Epistemic Tradition Backs it.md](2a.%20The%20Epistemic%20Tradition%20Backs%20it.md)

[2b. Propositions Are the Atoms of Inference.md](2b.%20Propositions%20Are%20the%20Atoms%20of%20Inference.md)

[2c. They Are the only Thing that Can Be Wrong.md](2c.%20Propositions%20Are%20the%20only%20Thing%20that%20Can%20Be%20Wrong.md)

[2d. It Maps to !writing to think!.md](2d.%20It%20Maps%20to%20!writing%20to%20think!.md)

[3. The case AGAINST (or! where the Claim overreaches).md](3.%20The%20case%20AGAINST%20(or!%20where%20the%20Claim%20overreaches).md)

[3a. Ryle's Distinction! Knowing-how Vs Knowing-that.md](3a.%20Ryle's%20Distinction!%20Knowing-how%20Vs%20Knowing-that.md)

[3b. Concepts Are Arguably More Fundamental.md](3b.%20Concepts%20Are%20Arguably%20More%20Fundamental.md)

[3c. Tacit Knowledge (Polanyi).md](3c.%20Tacit%20Knowledge%20(Polanyi).md)

[3d. Acquaintance Vs Description (Russell).md](3d.%20Acquaintance%20Vs%20Description%20(Russell).md)
...
You can verify this yourself: ask a raw LLM (no tool use enabled) to add two 4-digit numbers. It'll usually get it. Ask it to add two 15-digit numbers. It'll usually fail. A calculator wouldn't fail. A lookup table would either have it or not. The \_pattern of failure\_—competent within a range, degrading predictably beyond it—is the fingerprint of a learned procedure.
...
There isn't a ghost-in-the-machine version of addition that sits apart from its physical implementation. Every implementation of addition is patterns. Patterns of neurons, patterns of silicon, patterns of transformer weights. The question isn't \_"is it patterns?"\_—everything is. The question is *"do the patterns implement the algorithm reliably?"*

This is essentially the functionalist position in philosophy of mind, and it's the dominant view for a reason: if you demand something more than "patterns that reliably implement the function," you can't explain how \_anything\_—brains, calculators, or LLMs—manages to compute.
...
Most philosophers of mind take (b). It preserves the useful distinction (there really is a difference between *knowing that Paris is the capital of France* and \_knowing how to ride a bike\_) without invoking mysterious non-physical skills.
...
Something like: \_"LLM arithmetic is/is not genuine procedural knowledge because \__\_"\_—fill in the because with your current best reasoning. Don't aim for the final answer; aim to commit to a claim you can later contradict.
