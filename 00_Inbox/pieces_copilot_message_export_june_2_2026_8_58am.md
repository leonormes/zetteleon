---
created: 2026-06-02T07:58:28+00:00
modified: 2026-06-02T09:39:50+00:00
---
*Shared Message from Pieces (https://pieces.app) by Leon Ormes (leonormes@gmail.com) on Tuesday Jun 2, 2026 - 8:58 AM*
---
...
- PowerPoint deck (EaHSN SharePoint): [20250502\_Simplfied\_SDE\_architecture\_diagrams - Copy.pptx](https://eahsn.sharepoint.com/:p:/r/sites/EoESub-NationSDEWP2-12_DataHarmonisation2/Shared%20Documents/12_Data%20Harmonisation/06_DataProvider_info_pack/20250502_Simplfied_SDE_architecture_diagrams%20-%20Copy.pptx?d=w47c9b8af49f546c5b4c9a1d77f91ce32&csf=1&web=1&e=FS2KsX)
- Miro detailed diagram: [miro.com/app/board/uXjVI50q-Wc=/?share\_link\_id=175974256305](https://miro.com/app/board/uXjVI50q-Wc=/?share_link_id=175974256305)
...
1. **Where is the transient data copy stored during Node processing?** (e.g. MinIO? Is it encrypted at rest?)
   2. Within Minio in a seperate bucket which has a configurable retention policy on it. 
3. **Until when is it retained?** (Until query plan is complete? Until explicitly deleted? Other?)
   4. Until the configurable retention policy expires. Recommended 8hrs
5. **Is it re-fetched fresh each time the query is run**, or can it persist across runs?
   6. Yes
