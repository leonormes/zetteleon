...
modified: 2026-09-13 11:31:00+01:00
permalink: llmeon/30-library/200-projects/tracing-interests-to-their-first-principle-drivers-1
tags:
- domain/pkm
- topic/first-principles
- topic/metacognition
- topic/self-inquiry
title: Tracing Interests to Their First-Principle Drivers
---
...
```mermaid
graph LR
    A[Recurve archery] -->|provides| B[Immediate embodied feedback]
    B -->|may-satisfy| C[Competence]
    A -->|provides| D[Repeatable structure]
    D -->|may-satisfy| E[Orientation and control]
    F[Poorly defined practice session] -->|challenges| E
    G[High stress] -->|amplifies| E
    C -->|conflicts-with| H[Novelty seeking]
    C -->|predicts| I[Preference for progressive practice]
```
