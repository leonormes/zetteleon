...
![rw-book-cover](https://www.zdnet.com/a/img/resize/da04da6f3faac1defa2643a6924487ede972e0f7/2026/01/02/59ea2788-7fe4-4f53-8b93-5e08d33d257a/gettyimages-2239869452.jpg?auto=webp&fit=crop&height=675&width=1200)

## Metadata
- Author: [[Tiernan Ray]]
- Full Title: True agentic AI is years away - here's why and how we get there
- Category: #articles
- Summary: Today's AI "agents" are mostly simple automations and don't meet the true definition of autonomous agents.  
Two big missing pieces are robust reinforcement learning and long-term memory systems.  
Experts say solving these will take years, likely five or more.
- URL: https://www.zdnet.com/article/ai-agents-primitive-reinforcement-learning-complex-memory/

## Full Document
![AI concept](https://www.zdnet.com/a/img/resize/3e118c4e60c00d6f1f16896141d701923744c27b/2026/01/02/59ea2788-7fe4-4f53-8b93-5e08d33d257a/gettyimages-2239869452.jpg?auto=webp&width=1280)Yuichiro Chino/Moment/Getty Images
...
The giants of enterprise technology -- Microsoft, ServiceNow, Salesforce, and others -- have spent the past year and a half [unveiling various kinds of artificial intelligence agents](https://www.zdnet.com/article/meet-agentforce-salesforces-autonomous-ai-agent-answer-to-employee-burnout/#link={%22role%22:%22standard%22,%22href%22:%22https://www.zdnet.com/article/meet-agentforce-salesforces-autonomous-ai-agent-answer-to-employee-burnout/%22,%22target%22:%22%22,%22absolute%22:%22%22,%22linkText%22:%22unveiling various kinds of artificial intelligence agents%22}), programs that can automate many tasks within their respective software suites.

**Also: [AI killed the cloud-first strategy: Why hybrid computing is the only way forward now](https://www.zdnet.com/article/ai-kills-cloud-first-hybrid-computing-comeback/)**
...
Market data shows that agents haven't taken off. [A study](https://www.zdnet.com/article/anthropic-openai-enterprise-market-share-2025/) [released this month](https://www.zdnet.com/article/anthropic-openai-enterprise-market-share-2025/#link={%22role%22:%22standard%22,%22href%22:%22https://www.zdnet.com/article/anthropic-openai-enterprise-market-share-2025/%22,%22target%22:%22%22,%22absolute%22:%22%22,%22linkText%22:%22A study this month%22}) by venture capital firm Menlo Ventures revealed that the fastest-growing area of AI applications consists almost entirely of simpler co-pilot programs, such as ChatGPT Enterprise, Claude for Work, and Microsoft Copilot, versus agentic AI, including Salesforce Agentforce, Writer, and Glean.
...
As researchers Gaurav Kumar and Anna Rana of Stanford University and The IESE business school of the Universidad de Navarra, succinctly point out in [an overview of agents published this month](https://arxiv.org/abs/2512.14474), "Large Language Models have demonstrated impressive capabilities in reasoning and planning [but] LLM-based agents continue to fail in complex, multi-step planning tasks, frequently exhibiting constraint violations, inconsistent state tracking, and brittle solutions that break under minor changes."
...
There are numerous agentic tools available today, but they're not the answer. Offerings such as Microsoft's [Foundry IQ](https://www.zdnet.com/article/microsofts-new-ai-agents-wont-just-help-us-code-now-theyll-decide-what-to-code/) let a company build thousands of different kinds of agents. That's nice, but the shortcomings of agents are inherent to the technology at a fundamental level, and slick tools won't resolve those shortcomings.

**Also:** [**Microsoft's new AI agents won't just help us code, now they'll decide what to code**](https://www.zdnet.com/article/microsofts-new-ai-agents-wont-just-help-us-code-now-theyll-decide-what-to-code/)
...
1. Developing a reinforcement learning approach to designing agents.
2. Re-engineering AI's use of memory -- not just memory chips such as DRAM, but the whole phenomenon of storing and retrieving information.

Reinforcement learning, [which has been around for decades](https://www.zdnet.com/article/ai-scholars-win-turing-prize-for-technique-that-made-possible-alphagos-chess-triumph/#link={%22role%22:%22standard%22,%22href%22:%22https://www.zdnet.com/article/ai-scholars-win-turing-prize-for-technique-that-made-possible-alphagos-chess-triumph/%22,%22target%22:%22%22,%22absolute%22:%22%22,%22linkText%22:%22has been around for decades in AI%22}), has demonstrated striking results in enabling AI to carry out tasks over a very long time horizon.

The most notable example is Google DeepMind's [AlphaZero](https://deepmind.google/blog/alphazero-shedding-new-light-on-chess-shogi-and-go/#link={%22role%22:%22standard%22,%22href%22:%22https://deepmind.google/blog/alphazero-shedding-new-light-on-chess-shogi-and-go/%22,%22target%22:%22%22,%22absolute%22:%22%22,%22linkText%22:%22AlphaZero%22}), which was able to formulate rules for chess and the game of Go from scratch and then proceed through entire games at a level equal to or better than that of a human. That was all a result of reinforcement learning.
...
Reinforcement learning has increasingly been employed to improve LLM "reasoning" about a problem, such as the [DeepSeek AI models](https://www.zdnet.com/article/what-is-deepseek-ai-is-it-safe-heres-everything-you-need-to-know/) that stunned the world at the beginning of 2025.
...
Mingyue Cheng and colleagues at China's University of Science and Technology [in November unveiled](https://arxiv.org/abs/2511.14460) what they call Agent-R1, a way to train LLMs with reinforcement learning to predict rewards and devise policies.
...
Another group, led by Mingyang Sun of Westlake University, [unveiled Sophia this month,](https://arxiv.org/abs/2512.18202#link={%22role%22:%22standard%22,%22href%22:%22https://arxiv.org/abs/2512.18202%22,%22target%22:%22%22,%22absolute%22:%22%22,%22linkText%22:%22this month unveiled \%22Sophia,\%22%22}) which they describe as a "wrapper" that enables an LLM to perform tasks over "prolonged durations" when interacting with a web browser.
...
On the horizon looms a significant shift in reinforcement learning itself, which could be a boon or further complicate matters. Can AI do a better job of designing reinforcement learning than humans?
  ...
  Google DeepMind
That's the question posed by Google's DeepMind unit, the creators of AlphaZero, in a study published [this month](https://www.nature.com/articles/s41586-025-09761-x#link={%22role%22:%22standard%22,%22href%22:%22https://www.nature.com/articles/s41586-025-09761-x%22,%22target%22:%22%22,%22absolute%22:%22%22,%22linkText%22:%22this month reported%22}) in *Nature* magazine. An AI program called DiscoRL automatically invents improved reinforcement learning algorithms that, in turn, lead to better agents.
...
Anyone who's used a chatbot for a big project will notice that errors become more frequent, as bots can sometimes mistakenly insert information that came up much earlier in the conversation. [I described that situation myself](https://www.zdnet.com/article/i-built-a-business-plan-with-chatgpt-and-it-turned-into-a-cautionary-tale/#link={%22role%22:%22standard%22,%22href%22:%22https://www.zdnet.com/article/i-built-a-business-plan-with-chatgpt-and-it-turned-into-a-cautionary-tale/%22,%22target%22:%22%22,%22absolute%22:%22%22,%22linkText%22:%22I described that situation myself%22}) when I used ChatGPT over several days to formulate a business plan, and it started to insert incorrect variables into the calculation.

**Also:** [**I built a business plan with ChatGPT and it turned into a cautionary tale**](https://www.zdnet.com/article/i-built-a-business-plan-with-chatgpt-and-it-turned-into-a-cautionary-tale/)

The same kinds of failure across long spans of work are being seen by researchers when it comes to agents.

Stanford's Human-Centered AI group, in its annual State of AI report [published in April](https://www.zdnet.com/article/the-ai-model-race-has-suddenly-gotten-a-lot-closer-say-stanford-scholars/), noted that agents fall behind human ability the longer they are asked to perform. "In short time-horizon settings (two-hour budget), top AI systems score four times higher than human experts, but as the time budget increases, human performance surpasses AI --outscoring it two to one at 32 hours."

In a [report published this month](https://arxiv.org/abs/2512.13564), lead author Yuyang Hu of the National University of Singapore and collaborating institutions, wrote that memory is the key to alleviating such failures.
