...
- Full Title: Deploy agents instantly with Agent Builder templates
- Category: #articles
- Summary: LangSmith Agent Builder offers ready-to-use templates for building customizable agents quickly. These templates connect popular tools and learn from your feedback without complex setup. You can choose from many AI models and share your own agents with the community.
- URL: <https://www.blog.langchain.com/introducing-agent-builder-template-library/>

### Full Document

![Introducing Agent Builder templates](https://www.blog.langchain.com/content/images/size/w1520/format/webp/2026/01/LangSmith-Agent-Builder.png)Introducing Agent Builder templates
...
![](https://img.spacergif.org/v1/1528x1080/0a/spacer.png)0:000:33
...
![](https://www.blog.langchain.com/content/images/2026/01/agent-builder-arcade-1.png)
