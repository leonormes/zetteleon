# GitHub - YesYouKenSpace/zellij-smart-tabs · GitHub

![rw-book-cover](https://opengraph.githubassets.com/f762e76770fb3b5977f4cfe9aa95bbad45c03ac923eac7c9986e9db541a7aee2/YesYouKenSpace/zellij-smart-tabs)

## Metadata
- Author: [[https://github.com/YesYouKenSpace/]]
- Full Title: GitHub - YesYouKenSpace/zellij-smart-tabs · GitHub
- Category: #articles
- Summary: Zellij-smart-tabs is a plugin that automatically renames and manages tabs in the Zellij terminal to help users easily track their work. It uses customizable templates and allows manual renaming with simple commands and keybindings. The plugin also provides a dashboard UI and supports status reporting for better tab organization.
- URL: https://github.com/YesYouKenSpace/zellij-smart-tabs

## Full Document
### YesYouKenSpace/zellij-smart-tabs
...
| --- | --- | --- | --- |
| `format` | String | See [Format Gallery](https://github.com/YesYouKenSpace/zellij-smart-tabs/#format-gallery) | Tab name template (Jinja2-like syntax) |
...
Status is freeform - you can send any string. The [default status substitutions](https://github.com/YesYouKenSpace/zellij-smart-tabs/#default-status-substitutions) are applied automatically. Custom statuses without a substitution are shown as-is.
...
For Linux desktop notifications and other integrations, see the helper scripts in [`scripts/linux/`](https://github.com/YesYouKenSpace/zellij-smart-tabs/blob/main/scripts/linux).
