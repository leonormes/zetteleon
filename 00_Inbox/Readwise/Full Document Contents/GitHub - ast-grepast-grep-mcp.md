...
modified: 2026-01-18T09:18:34+00:00
tags: [articles]
title: GitHub - ast-grep/ast-grep-mcp
---

# GitHub - ast-grep/ast-grep-mcp

![rw-book-cover](https://opengraph.githubassets.com/a73f61f0d43f1eb506b388ba29b4701458c47326298efdbe90408b951278195e/ast-grep/ast-grep-mcp)

## Metadata

- Author: [[GitHub]]
- Full Title: GitHub - ast-grep/ast-grep-mcp
- Category: #articles
- Summary: The ast-grep-mcp server lets AI assistants search and analyze code using syntax patterns instead of text. It supports many languages and uses YAML rules to find complex code structures. Users can run, test, and customize searches to better understand and work with codebases.
- URL: <https://share.google/pI7smFxB2hCYDgGzD>
...
- [README](https://github.com/ast-grep/ast-grep-mcp/#)
- [MIT license](https://github.com/ast-grep/ast-grep-mcp/#)
...
The MCP server supports using a custom `sgconfig.yaml` file to configure ast-grep behavior. See the [ast-grep configuration documentation](https://ast-grep.github.io/guide/project/project-config.html) for details on the config file format.
...
[![MseeP.ai Security Assessment Badge](https://camo.githubusercontent.com/f1b0d5bfbea736884cc7053c3aeb266622f055266c68f956728ba7b19afdc507/68747470733a2f2f6d736565702e6e65742f70722f6173742d677265702d6173742d677265702d6d63702d62616467652e706e67)](https://mseep.ai/app/ast-grep-ast-grep-mcp)
