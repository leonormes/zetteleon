# Amplenotes fixed my chaotic to-do list thanks to its score system

![rw-book-cover](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2026/01/the-tasks-view-in-amplenote-on-a-laptop.jpg?w=1600&h=900&fit=crop)

## Metadata
- Author: [[Megan Ellis]]
- Full Title: Amplenotes fixed my chaotic to-do list thanks to its score system
- Category: #articles
- Summary: Amplenote helps organize tasks by giving each a score based on importance and urgency. This score lets you see your most important tasks first and filter out less urgent ones. The app also makes it easy to turn notes into scheduled tasks with simple tools and shortcuts.
- URL: https://www.xda-developers.com/amplenote-task-system-fixed-chaos/

## Full Document
![the tasks view in amplenote on a laptop](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2026/01/the-tasks-view-in-amplenote-on-a-laptop.jpg?&fit=crop&w=1600&h=900) 
...
That's why Amplenote's Task Score system caught my interest. In addition to a few other features in the [productivity software](https://www.xda-developers.com/tools-supercharge-productivity-windows/), its ability to assign a score to tasks and sort them accordingly gives you a way to filter through your to-do list.

 ![Outline on a monitor.](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/07/reasons-outline-is-best-onenote-alternative.jpg?q=49&fit=crop&w=220&h=182&dpr=2) 
####  What is Amplenote?
...
#####  You can filter out less important tasks
   ...
   ![filtering amplenote tasks according to high value filter](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2026/01/filtering-amplenote-tasks-according-to-high-value-filter.jpg?q=49&fit=crop&w=825&dpr=2) 
...
#####  A variety of shortcuts and commands are at your disposal
   ...
   ![amplenote note with tasks](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2026/01/amplenote-note-with-tasks.jpg?q=49&fit=crop&w=825&dpr=2) 
I was slightly skeptical about Amplenote since it aims to replace so many productivity apps and [I've stopped trusting apps that try to do everything](https://www.xda-developers.com/stopped-trusting-software-tries-everything/). However, I am impressed by how easy it is to create tasks from your notes and add them to your calendar.
...
However, at the same time, Amplenote does sometimes get in its own way. Since there's a lot of functionality in the app, it tries to help you discover this with a bunch of demo tasks. But this can get frustrating when you just want to get started using the app.
   ...
   ![demo note and tasks in amplenote](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2026/01/demo-note-and-tasks-in-amplenote.jpg?q=49&fit=crop&w=825&dpr=2) 
...
One of the [drawbacks of productivity apps](https://www.xda-developers.com/productivity-app-drawbacks/) that I often encounter is that they can be overwhelming. Lightweight tutorials can be helpful, but too much demo content can feel more like bloat — especially when tasks include things like following the company on social media.
...
Despite this frustration, I do think Amplenote has something appealing to offer, especially for people who enjoy comprehensive task management solutions. The ability to schedule tasks to repeat according to completion dates, for example, is something I'm keen to explore more.
 ...
 ![NotebookLM and Perplexity's website displayed ](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/06/notebooklm-and-perplexity-s-website-displayed.jpg?q=49&fit=crop&w=220&h=182&dpr=2) 
