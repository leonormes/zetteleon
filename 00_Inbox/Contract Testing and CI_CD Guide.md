...
> 2. **The Baseline Group:** A freshly deployed, isolated instance of the *existing* production code34.  
> 3. **The Canary Group:** An isolated instance of the *new* code34.
