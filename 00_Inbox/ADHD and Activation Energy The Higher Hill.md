...
Difficulties with emotional regulation, common in ADHD, can also play a role. If a task is associated with negative feelings (boredom, frustration, fear of failure), it can feel even more daunting to start, effectively increasing the activation energy. Feelings of being overwhelmed, for example, are common in ADHD when looking at a complex task.
...
## 3\. Executive Function: The Project Manager

!\[\[Executive Function The Project Manager\]\]

## 4\. The Interplay: ADHD, Activation Energy, and Executive Function

!\[\[The Interplay ADHD, Activation Energy, and Executive Function\]\]

## Strategies to Help

!\[[Strategies to Help](#bookmark=id.uy8hbskpin)\]
