...
- evidence: "By offloading thoughts onto a page or a screen, you free up valuable mental resources. This offloading allows your mind to focus on making decisions and solving problems rather than struggling to remember information." (no timestamp)
- implications:
  - Externalisation is necessary for complex thinking that exceeds natural attention windows.
  - Productivity is enhanced by shifting mental duty from retention to processing.
- confidence: high
...
- evidence: "Writing an idea down in a way that makes sense is the only way to truly determine if you have understood a topic. When you translate an external concept into your own words, you force your brain to grasp the underlying principle." (no timestamp)
- implications:
  - Writing serves as a diagnostic tool for identifying knowledge gaps.
  - Ownership of an idea requires active linguistic struggle rather than passive ingestion.
- confidence: high
...
- evidence: "By manually linking ideas together, you discover unexpected connections and patterns that an AI simply cannot deduce, because the AI does not share your personal context or your unique trains of thought." (no timestamp)
- implications:
  - The value of a PKM system lies in its ability to reflect the user's unique thought history.
  - Connection-building is a personal act that differentiates human insight from machine-generated content.
- confidence: medium
- tags: [pkm, ai, insight, knowledge-graphs]
