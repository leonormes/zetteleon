...
modified: 2026-06-11T13:34:53+00:00
title: missing_from_calibre
---

## Books to Download—BookFusion → Calibre

These 83 books are in your BookFusion library but not found in your Calibre library

(at `/Users/leon.ormes/My Drive/GCcalibreBooks/`).
...
- Match method: Title normalisation (lowercase, strip punctuation, collapse whitespace, remove parentheticals like "(for Leon Ormes)").
- 418/501 BookFusion books matched in Calibre.
- Duplicate check: Some missing entries may already exist under slightly different titles—manually verify before downloading.
- "A Mathematician's Apology" has a corrupted author field in the export (`PScript5.dll Version 5.2`); actual author is G.H. Hardy.
