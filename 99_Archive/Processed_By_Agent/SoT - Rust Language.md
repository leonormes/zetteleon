---
aliases: ["Rust Design", "Rust Philosophy", "Rust vs TypeScript", "RustLang", "The Rust Language"]
confidence: "5/5"
...
see_also: ["[[MOC - Rust Programming Language]]", "[[SoT - Rust Type Mechanics]]", "[[SoT - Rust's Ownership Model]]", "[[SoT - Type-Driven Development (The Torvalds Loop)]]"]
source_of_truth: []
status: "stable"
tags: ["design-philosophy", "programming-language", "rust", "systems", "typescript"]
...
- The Axiom (Physics): [[SoT - Data-Centric Software Engineering]]—_Structure is truth._
- The Theory (Math): [[MOC - Type Theory]]—_Affine Types ensure valid state transitions._
- The Tool (Language): [[SoT - Rust Language]]—_The compiler that enforces these laws._
...
- Concept: A resource (value) can be used _at most once_.
...
Rust is the _lingua franca_ of Data-Oriented Programming (DOP) because it exposes memory layout control without sacrificing safety.
