...
purpose: "To define the routing logic that classifies inputs into Kinetic (Action), Static (Storage), or Dynamic (Thinking) states."
quality-markers: ["Addresses edge cases like Projects.", "Defines the three metabolic states.", "Provides clear routing logic table."]
