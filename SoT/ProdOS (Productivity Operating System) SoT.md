---
aliases: [My Productivity System, Principle-Centered Productivity, ProdOS, ProdOS Product Description]
confidence: 
...
It is built on a core philosophy: **Process over Goals, Action over Collection, and Synthesis over Hoarding.**

ProdOS is not a single app, but a cohesive workflow integrating **Obsidian** for knowledge, **Todoist** for tasks, and an **LLM as a "Chief of Staff"** to automate, synthesise, and guide.
...
1.  **The World of Action:** The need to execute tasks, manage projects, and get things done (GTD).
2.  **The World of Knowledge:** The drive to document, understand, and retain complex technical information (Learning).
3.  **The World of Ideas:** The desire to connect disparate concepts, innovate, and generate novel insights (PKM/Zettelkasten).

Trying to manage these with separate, disconnected tools leads to the **ADHD Satisfaction Trap**: a cycle of novelty-seeking, context-switching, and system-tinkering that feels productive but results in fragmented knowledge, abandoned projects, and the depressing feeling of "starting over" on ideas you've had before. 
...
## 3. The A-C-T Framework: The Core of ProdOS

ProdOS is built on the **A-C-T (Action-Container-Thought) Framework**, a core processing loop that ensures that amorphous ideas are converted into concrete, minimal actions (MVAs) and that the learnings from those actions are reintegrated into the knowledge base. This creates a virtuous cycle of thoughtful action, rather than aimless thinking or unreflective doing.
...
## 4. ADHD-Aware By Design

ProdOS is explicitly designed to work *with* an ADHD brain, not against it. Your brain is for *having* ideas, not *holding* them.

-   **Lowers Activation Energy:** MVAs and "Two-Minute Rules" for every process.
-   **Manages Context Loss:** The "Working Note Pattern" and "Reuse-First" prompts create stateful thinking traces, making it easy to pick up where you left off.
-   **Channels Novelty-Seeking:** Instead of system-hopping, novelty is found in "spikes" and exploring the emergent connections in your knowledge graph.
-   **Externalizes Executive Function:** The LLM Chief of Staff handles planning, prioritization, and synthesis, freeing your cognitive resources for deep thinking and creative work.
