---
title: 2026-07-31-evidence-limbic-friction
type: note
permalink: llmeon/90-audits/2026-07-31-evidence-limbic-friction
---

## Positioning — [[Evidence - Limbic Friction as Anxiety or Tiredness Activation Cost]] — 2026-07-31
...
Existing link count out: 2 (typed edge to `Limbic Friction is the Activation Energy for Habits`, plain link to `MOC - The Science of Making and Breaking Habits`).
...
|---|---|---|---|---|---|
| `Limbic Friction is the Activation Energy for Habits.md` | **Use:** Target acts as empirical evidence supporting this claim. | Yes. | No. | Yes. | Pass (Edge: Target `supports` Candidate - existing but needs format strip) |
...
| `proposition` | (missing) | `Limbic friction represents the activation energy required to initiate a habit, driven by underlying anxiety or tiredness.` |
...
### Verdict
Following the enrichment pass, `Evidence - Limbic Friction...` has been transformed from an inbound orphan with legacy formatting into a structurally compliant ProdOS evidence note. It correctly supports its target claim.
...
- **Thread 1 (Habit Activation Energy):**
  `Evidence - Limbic Friction...` (Evidence)
  ↳ `supports` -> `Limbic Friction is the Activation Energy for Habits` (Atomic Claim)

### Traversal Manifest
- **Inbound:**
  - None.
- **Outbound:**
  - `Limbic Friction is the Activation Energy for Habits.md` -> [Typed Edge: `supports`]
  - `MOC - The Science of Making and Breaking Habits.md` -> [Plain Link (Mention)]
