...
1. Objectives (What Hermes should deliver)
...
1. Inputs (Data you've collected and should be used)
...
1. Tools Hermes Should Deploy/Leverage (pick the best tool per job)
...
1. Outputs and Artifact Deliverables
...
1. Proposed Execution Plan (phases and milestones)
...
1. Output Template (what Hermes should return as final artifacts)
...
1. How to cite sources and memory anchors in Hermes outputs
...
1. Example Snippet (for quick reference)
...
1. Quick reference to your memory anchors (for Hermes)
