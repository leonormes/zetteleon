...
- [[SOT - CI-CD Pipelines|CI/CD Pipelines]]—Incremental investigation and optimisation of a live GitOps deployment pipeline measured via Four Key Metrics; no big-bang replacements.
...
- [[SOT - CI-CD Pipelines|CI/CD Pipelines]]—GitLab CI/CD automation research for FITFILE/Hermes: comprehensive search synthesis, 7-phase TRANSFER artifact, cursor-based pagination workflow (2026-05-18).
