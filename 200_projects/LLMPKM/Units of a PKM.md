...
## Units and Concepts for a PKM

### 1. Core Knowledge Units
...
### 2. Note Types (By Workflow/Purpose)
...
These are fields or tags used to classify and manage notes.
...
#### Example Semantic Metadata (from IOED section)

- `%%concept.definition:strength=4%%`
- `%%evidence.empirical{citation-key}:strength=3%%`
- `%%concept.extends{concept-name}:strength=3%%`
- `%%concept.solution{problem-name}:strength=4%%`
- `%%understanding.mechanical%%`
- `%%concept.relationship{concept1 concept2}:strength=5%%`
- `%%concept.insight%%`
