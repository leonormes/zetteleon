...
last_updated: 2026-05-28T21:00:00+01:00
...
| FTFL-476 | Jira | OMOP Stress Testing infra + monitoring | 🔴 critical | 🚫Blocked | 2026-05-18 | Identify blocker, escalate or deprioritise (11+ days blocked) |
...
- **Jira data fresh**: Successful fetch via `jira-fetch.js` at 2026-05-28 21:00 UTC. All 8 open issues confirmed.
- **FTFL-638** updated 2026-05-28 08:57. Active work in progress — branch `feature/FTFL-638-add-labels-for-logs` exists.
- **FTFL-476** blocked since 2026-05-18 (11+ days). No movement. Needs escalation or explicit deprioritisation.
...
- No new issues since 16:00 run (2026-05-28).
- No disappeared issues — all prior SoT tickets still present in Jira open query.
- **No state change since 16:00 run** — all priorities, statuses, and next actions unchanged.
