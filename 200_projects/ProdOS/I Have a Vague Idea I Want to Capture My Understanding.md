...
epistemic: 
last_reviewed: 
modified: 2025-12-04T15:05:59Z
purpose: 
review_interval: 
see_also: []
source_of_truth: []
status: 
tags: [k8s, pkm, terraform]
title: I Have a Vague Idea I Want to Capture My Understanding
type: 
uid: 
updated: 
---
...
- **Generous Use of Backlinks:** Each note should link out to at least one related topic or context; use tags for technologies (e.g., #k8s, #terraform).
- **Maps of Content (MOCs):** Build index pages for each major topic (e.g., “Kubernetes Network MOC”) that list related atomic notes.
- **Mind Mapping/Visual Models:** Use Excalidraw/ExcaliBrain to map mental models for high-level understanding.

### 3. Reflection and Retrieval

- **Weekly Reviews:** Summarize new insights and update MOCs with new connections.
- **Regular Maintenance:** Prune and consolidate duplicate or outdated notes.

### 4. Plugins and Automation (Advanced)

- **Smart Connections/Ollama Integration:** Enable semantic search and LLM-powered queries over your vault for advanced retrieval and note rewriting.
- **Templates and Dataview:** Automate standardization of note types and create dashboards/MOCs.
...
- Focus your PKM on what *you* find confusing, complex, or insightful.
- Treat the vault as a thinking partner—not just a reference library.
- Regularly rewrite and link notes for better synthesis and retrieval.
