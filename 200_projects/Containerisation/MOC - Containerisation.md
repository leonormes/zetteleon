...
3. Connect concepts with [[Pods communicate across cluster using CNI-provided networking]] and [[containers within a pod share network namespace and IP address]]
...
- [[Containers within a pod share network namespace and IP address]] - Pod-level container communication
