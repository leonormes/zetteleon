...
source_of_truth: []
status: seedling
tags: [map, topic/social-cognition, topic/social-perception]
...
This map explores how humans form rapid judgments about social interactions—assessing likability, agreement, status, and comfort—and the substantial margin for error inherent in these processes. It connects mechanisms of perception, systematic biases that distort judgments, and strategies for calibrating self-awareness.

### Core Mechanisms

How we gather and process social information:

- [[Non-Verbal Cues in Social Judgment]] rel:: supports [[Pattern Recognition in Social Cognition]]
- [[Paralanguage and Vocal Tone in Communication]] rel:: supports [[Pattern Recognition in Social Cognition]]
...
Cognitive biases that systematically distort social judgment:

- [[Confirmation Bias Distorts Social Perception]] rel:: specializes [[Cognitive Biases Reinforce Mental Models]]
- [[Fundamental Attribution Error]] rel:: distorts [[Pattern Recognition in Social Cognition]]
- [[Mind-Reading Fallacy and Projection]] rel:: relates_to [[Illusion of Explanatory Depth (IoED)]]
- [[Spotlight Effect]] rel:: influences [[Meta-Accuracy in Social Perception]]
...
Understanding and improving the accuracy of social self-perception:

- [[Meta-Accuracy in Social Perception]] rel:: defines accuracy of beliefs about others' perceptions
- [[Meta-Accuracy in Social Perception]] rel:: is_calibrated_by [[Feedback-Seeking Strategies for Calibration]]
...
How emotions shape and are shaped by social perception:

- [[Emotional Contagion in Social Settings]] rel:: drives [[The Cognitive-Emotional Feedback Loop]]
...
Social perception accuracy (~50-60%) is better than chance but far from perfect. Accuracy improves with:

- Relationship closeness (friends > strangers)
- Observable traits (dominance > anxiety)
- Multiple data points across contexts
- Conscious calibration through feedback

Most systematic error is toward underestimating acceptance rather than overestimating it.
