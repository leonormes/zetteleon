...
[[ADHD Causes Deficits in Completing Long-Term Projects]] rel:: describes-problem

The specific challenge: When actively creating, my thoughts are wrapped up in the work. The mental model feels strong, unique, and complete—I can feel the bigger picture, the hierarchy, the system as a whole. It feels right and enjoyable.

When I return after a break, my thoughts are no longer wrapped up in it. The mental model has dissipated. The project now feels too complex to re-enter, as I've forgotten the structure. The work has lost its novelty—by definition, it's not new anymore—and the ADHD brain craves newness.
...
#### Capture and Externalize the Mental Model

[[Documenting Mental Models Enables Project Re-entry]] rel:: solution strategy:: "Capture mental models while in flow"
...
[[Breaking Projects Into Micro-Tasks Reduces ADHD Overwhelm]] rel:: solution strategy:: "Decompose for clarity"
...
[[Visual Schedules Make Routines Tangible]] rel:: solution strategy:: "Maintain visible context"
...
[[External Accountability Sustains ADHD Project Commitment]] rel:: solution strategy:: "Add social stakes"
...
- [[The Motivation Bridge - An ADHD Metaphor]] rel:: explains motivation:: "Make it urgent, novel, or interesting"
- [[Non-Linear Workflows for ADHD Task Initiation]] rel:: supports strategy:: "Start where you have energy"
- [[Mental Models The Developer's Internal Compass]] rel:: background concept:: "Nature of mental models"
- [[The Done State as a Boundary for ADHD Projects]] rel:: complementary strategy:: "Define concrete success criteria"
