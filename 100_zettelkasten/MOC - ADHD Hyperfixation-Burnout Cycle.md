...
What you're experiencing is a very common, yet often misunderstood, pattern for people with ADHD. It's incredibly frustrating to feel like you're on a constant rollercoaster of intense engagement followed by a complete mental void. [[ADHD Hyperfixation-Burnout Cycle]] `rel:: defines` this pattern—a powerful and consuming wave of interest that is neurological in origin, driven by the unique wiring of the ADHD brain.

This entire process can be best understood not as a personal failing, but as your brain's powerful, albeit erratic, search for stimulation and reward. [[Dopamine Dysregulation is a Key Factor in ADHD Motivation]] `rel:: underlies` the entire cycle, creating the fundamental drive that powers each phase.

### The Anatomy of the ADHD Interest Cycle

#### Phase 1: The Spark and the Slow Burn (The Search for Dopamine)

This is where it all begins. [[ADHD Brain Constantly Scans for Dopamine-Rewarding Stimuli]] `rel:: initiates` the cycle. Your brain, which has a different dopamine regulation system, is constantly scanning the environment for something that will provide a sense of reward and stimulation. This isn't a conscious choice; it's a fundamental drive.
