...
source_of_truth: []
status: 
tags: [cognition, learning, map, memory, study-habits, understanding]
...
## MOC - Understanding Vs Learning

> **Inclusion criteria:** Atomic only; must be evergreen or growing.

This map explores the critical differences between 'understanding' and 'learning' to dissect the challenge of mastering complex subjects and moving beyond surface-level familiarity.

---

### 1. Conceptual Foundations

The journey begins with a clear distinction: [[Learning is the Acquisition of Information While Understanding is the Construction of Meaning|learning is about acquisition, while understanding is about constructing meaning]]. However, a significant barrier to achieving deep understanding is the [[The Illusion of Fluency is a Cognitive Bias Where Ease of Processing is Mistaken for Deep Learning|Illusion of Fluency]], a cognitive bias often created by [[Passive Study Habits Foster the Illusion of Fluency|passive study habits]].
...
### 2. Evidence-Based Strategies for Deep Learning
