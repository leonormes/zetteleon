---
aliases: [Map of Content on ADHD Motivation]
confidence:
...
source_of_truth: []
status:
tags: [motivation, topic/health/adhd, type/moc]
title: ADHD and Motivation MOC
type: map
uid:
updated:
version: 1
...
This Map of Content (MOC) organizes notes related to the unique motivational system of the ADHD brain. For a parable illustrating the importance of addressing root causes in productivity, see [[Parable of the Bitter Spring]].
