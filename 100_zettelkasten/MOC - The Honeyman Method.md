...
source_of_truth: []
status: 
tags: [autism, energy-management, map, routines, self-compassion, topic/health/adhd]
...
1. List all tasks for your "ideal" routine on a great day with maximum motivation.
2. Scale down to create your "most likely" version for average days. Make tasks quicker or optional.
3. [[Making minimums truly attainable addresses executive dysfunction]]. For some, even just eating breakfast is considered a win.
4. Accept energy variation as normal—don't judge yourself for needing minimum routines on hard days. [[Cultivating Self-Compassion for ADHD]] is essential for sustainable habit formation.
5. Use the same model for both morning and evening routines, tailoring the activities and thresholds for each time period.
...
### ADHD Strategy Principles Highlighted
...
1. Write out your "ideal" morning and evening routines step by step.
2. Create "most likely" and "minimum" versions beneath each ideal step.
3. [[Daily tier selection based on current energy improves routine consistency]]. Review each morning, choosing which tier fits your energy.
4. Accept and normalize switching between tiers as needed. The tier you choose is always the "right" choice for that day.

### Key Insight

[[Multi-tier routine systems improve consistency and self-compassion]] for ADHD and autistic individuals, supporting daily function without setting unrealistic expectations. The framework acknowledges that neurodivergent nervous systems operate with variable capacity—not as a flaw to overcome, but as a reality to accommodate intelligently.
...
Hayley Honeyman, "Honeyman Method" for ADHD routines

<https://www.youtube.com/watch?v=JQFZNQS6eQ0&si=aJON_ftW7HkzZnhv>
