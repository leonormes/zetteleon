...
![rw-book-cover](https://cdn.kustomerhostedcontent.com/media/623b25d297003b3fefc740e1/1cfcfdb0f29e881e9c8cbb992f3f7f72.png)

### Metadata
- Author: [[ynab.com]]
- Full Title: Getting Started with Targets
- Category: #articles
- Summary: YNAB targets help you save or refill money for expenses on monthly, yearly, or custom schedules. You choose a behavior (set aside, refill, or have a balance) to control how the target repeats and funds. Use targets to plan regular bills, one-time goals, or irregular expenses and track progress.
- URL: <https://support.ynab.com/en_us/getting-started-with-targets-ryAEP08xC>

### Full Document

[Back to Top](https://support.ynab.com/en_us/getting-started-with-targets-ryAEP08xC#backtotop)
...
**With the “Set aside another...” behavior**, the target will prompt you to assign the full amount of the monthly target again. Money will build up in the category over time. With this option, money will build up in the category over time.
...
Assign and spend up to this amount by a given date. YNAB will prompt you to assign a certain amount each month to stay on track to meet the target amount. The custom section gives you more options for tracking progress. You can choose whether you want the target to repeat or not, and how often.
...
|  |
| --- |
| Adding your first target? Here are the steps you need to create it and modify it. [How to Use Targets ↗️](https://support.ynab.com/en_us/how-to-use-targets-rk5kkI9ks) |
| Target not calculating or displaying as expected? Need some help from our Support team with your specific scenario? [How to Get Help in YNAB ↗️](https://support.ynab.com/en_us/how-to-get-help-SygqcvtC5) |
| Want to create a template to keep your spending priorities in mind? [Creating a Budget Template: A Guide ↗️](https://support.ynab.com/en_us/creating-a-budget-template-a-guide-ByZJZx_R9) |
| Want to use Auto-Assign to quickly fund your targets? [Auto-Assign: A Guide ↗️](https://support.ynab.com/en_us/auto-assign-a-guide-r1gBNbBJo) |
| Want to track your targets visually? Want to learn what the colors and shading mean and how these visuals are affected by your targets? [Progress Bars: A Guide ↗️](https://support.ynab.com/en_us/progress-bars-a-guide-SkDEhot09) |
| Want to temporarily snooze a target to prevent being alerted with yellow or red in your spending plan? [Snooze a Target ↗️](https://support.ynab.com/en_us/snooze-a-target-HyS4E5rZT) |
| Wondering about the different target options in categories paired with accounts? Want to learn more about these three special target types? [Targets for Categories Paired with Accounts: An Overview ↗️](https://support.ynab.com/en_us/targets-for-categories-paired-with-accounts-an-overview-BJJI8rdC5) |
| Notice your targets haven't been completely funded? Want to fund them quickly? [Underfunded: A Guide ↗️](https://support.ynab.com/en_us/underfunded-a-guide-BJwPhQO09) |
...
**Support**: If you have a question or would like a response to your specific question, please use the steps laid out in [How to Get Help in YNAB ↗️](https://support.ynab.com/en_us/how-to-get-help-SygqcvtC5) to ensure that your message gets to our Support team!
