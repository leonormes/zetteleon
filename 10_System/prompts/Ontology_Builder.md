...
_Use this when you want to rebuild the entire map from scratch or analyze a large set of new folders._
...
_Use this when you have dumped a lot of new notes into `00_Inbox` or `20_Thinking` and want to see where they fit._
...
_Use this when you want to deepen your understanding of a specific domain (e.g., "Software") by finding its root axioms._
...
_Use this when the Ontology note text has changed, and you need to update the visual diagram._
...
_Use this when you feel stuck or siloed in one topic._
