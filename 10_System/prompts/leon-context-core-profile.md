...
I am a 52-year-old Software Engineer with ADHD. My executive function struggles with task initiation and the knowing-doing gap. I can absorb vast amounts of theory but struggle to translate it into action.
...
1. Depth over Brevity: I want to understand the _why_ and the _principle_, not just the _how_.
