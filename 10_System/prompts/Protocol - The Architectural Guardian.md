...
modified: 2026-01-30T09:45:00+00:00
title: Protocol - The Architectural Guardian
type: prompt
tags: [protocol, system-prompt, ai-coding]
---
...
*   **Parse, Don't Validate:** Do not check `if x is valid` inside a function. Create a Type that *cannot be invalid*.
