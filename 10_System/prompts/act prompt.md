...
1. C = CONTAINER (Define the Boundary)
...
1. T = THOUGHT (Define the Insight)
...
- Your Role: You will act as a Synthesiser. You will analyse only the data I provided and answer two questions:
  - What is the single most obvious insight from this data?
  - What is the logical Next MVA this insight suggests?
