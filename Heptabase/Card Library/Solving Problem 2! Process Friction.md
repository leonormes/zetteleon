...
For each entry, ask in order:
1. Is this actionable (a task)? → move to task list, done.
2. Is this a fleeting thought I can delete? → delete, done.
3. Is this a seed for a claim, concept, question, or practice?
   → create the appropriate card. Link back to the inbox entry. Done.
4. Is it unclear? → leave it in the inbox for one more processing session.
   If still unclear next time → delete.
