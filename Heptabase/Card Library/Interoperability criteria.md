...
[C4.1! Asks if the product exposes any Application Programme Interfaces (APIs) or integration chan.md](C4.1!%20Asks%20if%20the%20product%20exposes%20any%20Application%20Programme%20Interfaces%20(APIs)%20or%20integration%20chan.md)

[C4.2! Asks if the product uses the NHS number to identify patient record data. If yes, it asks if.md](C4.2!%20Asks%20if%20the%20product%20uses%20the%20NHS%20number%20to%20identify%20patient%20record%20data.%20If%20yes,%20it%20asks%20if.md)

[C4.3! Evaluates the product's capability for read!write operations with electronic health records.md](C4.3!%20Evaluates%20the%20product's%20capability%20for%20read!write%20operations%20with%20electronic%20health%20records.md)

[C4.4! Asks if the product is a wearable or device or integrates with them. If yes, evidence must .md](C4.4!%20Asks%20if%20the%20product%20is%20a%20wearable%20or%20device%20or%20integrates%20with%20them.%20If%20yes,%20evidence%20must%20.md)
