...
- The Hall (The "Type"): This categorises the *nature* of the memory, filtering by facts/decisions, milestones/events, preferences/habits, or advice \[[03:09](http://www.youtube.com/watch?v=4RHgCJVcdQM&t=189)\].
...
The Tech Stack & Knowledge Graph Under the hood, the system is completely free and runs locally \[[09:08](http://www.youtube.com/watch?v=4RHgCJVcdQM&t=548)\]. It stores the "Drawers" in Chroma DB (a vector database for semantic search) and uses SQLite to maintain a Knowledge Graph. This graph tracks "temporal entity triples"—meaning it understands *when* a fact stops being true (e.g., if you change jobs, it won't mistakenly recall your old job as your current one for new queries) \[[09:43](http://www.youtube.com/watch?v=4RHgCJVcdQM&t=583)\].
...
Link to video: <https://www.youtube.com/watch?v=4RHgCJVcdQM>[Mansel Scheffel · 8.2k views](http://www.youtube.com/watch?v=4RHgCJVcdQM)