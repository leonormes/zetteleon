...
## building_linux_containers_using_base_linux_primitives

The document is a tutorial by Stéphane Graber and Christian Brauner on building Linux containers using base Linux primitives, emphasizing concepts like namespaces, cgroups, and security mechanisms. Here's a summary with elaboration on key points:

### Introduction to Containers

- Containers are isolated systems that share the host kernel without virtualizing hardware or firmware.
- They are user-space constructs, combining Linux kernel features like namespaces and cgroups for process isolation and resource control.
