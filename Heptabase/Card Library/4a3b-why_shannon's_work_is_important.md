...
In information theory, entropy is a key concept that quantifies the amount of uncertainty or unpredictability in a set of possible outcomes. Claude Shannon introduced this concept to measure the information content of a message. The more uncertain or random a message is, the higher its entropy, and the more information it conveys when the message is finally known.
