...
The :vimgrep command populates the quickfix list with one entry for each line that contains a match. Navigate through the results using commands such as :cnext and :cprev (see Tip 106Browse the Quickfix List).
