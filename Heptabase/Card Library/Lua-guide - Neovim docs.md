...
### Some words on the API [lua-guide-api](#lua-guide-api)
...
## Using Lua [lua-guide-using-Lua](#lua-guide-using-Lua)
...
### Using Lua files on startup [lua-guide-config](#lua-guide-config)

Nvim supports using `init.vim` or `init.lua` as the configuration file, but not both at the same time. This should be placed in your [config](https://neovim.io/doc/user/starting.html#config) directory, which is typically `~/.config/nvim` for Linux, BSD, or macOS, and `~/AppData/Local/nvim/` for Windows. Note that you can use Lua in `init.vim` and Vimscript in `init.lua`, which will be covered below.
...
### Lua modules [lua-guide-modules](#lua-guide-modules)
...
## Using Vim commands and functions from Lua [lua-guide-vimscript](#lua-guide-vimscript)

All Vim commands and functions are accessible from Lua.

### Vim commands [lua-guide-vim-commands](#lua-guide-vim-commands)
...
### Variables [lua-guide-variables](#lua-guide-variables)
...
## Options [lua-guide-options](#lua-guide-options)
...
## Mappings [lua-guide-mappings](#lua-guide-mappings)
...
### Creating mappings [lua-guide-mappings-set](#lua-guide-mappings-set)
...
### Removing mappings [lua-guide-mappings-del](#lua-guide-mappings-del)
...
## Autocommands [lua-guide-autocommands](#lua-guide-autocommands)
...
### Creating autocommands [lua-guide-autocommand-create](#lua-guide-autocommand-create)
...
### Grouping autocommands [lua-guide-autocommands-group](#lua-guide-autocommands-group)
...
### Deleting autocommands [lua-guide-autocommands-delete](#lua-guide-autocommands-delete)
...
## User commands [lua-guide-commands](#lua-guide-commands)
...
### Creating user commands [lua-guide-commands-create](#lua-guide-commands-create)
...
### Deleting user commands [lua-guide-commands-delete](#lua-guide-commands-delete)
...
Source: <https://neovim.io/doc/user/lua-guide.html#lua-guide>