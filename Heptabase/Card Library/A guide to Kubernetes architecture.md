...
![kubernetes-architecture-diagram.png](kubernetes-architecture-diagram.png "Kubernetes architecture diagram")
...
- Provides \[optimistic concurrency locking\]([https://stackoverflow.com/questions/52910322/kubernetes-resource-versioning#:\~:text=Optimistic concurrency control (sometimes referred,updated%2C the version number increases](https://stackoverflow.com/questions/52910322/kubernetes-resource-versioning#:\~:text=Optimistic%20concurrency%20control%20\\(sometimes%20referred,updated%2C%20the%20version%20number%20increases).), so other clients never override changes to an object in the event of concurrent updates.
...
- Responsible for [admission control](https://kubernetes.io/docs/reference/access-authn-authz/admission-controllers/) if the request is trying to create, modify, or delete a resource. For example, AlwaysPullImages, DefaultStorageClass, and ResourceQuota.
...
The Controller Manager also performs lifecycle functions such as namespace creation and lifecycle, event garbage collection, terminated-pod garbage collection, [cascading-deletion garbage collection](https://kubernetes.io/docs/concepts/architecture/garbage-collection/), and node garbage collection. See [Cloud Controller Manager](https://kubernetes.io/docs/concepts/architecture/cloud-controller/) for more information.
...
**\[ Read next: [How Kubernetes creates and runs containers: An illustrated guide](https://www.redhat.com/architect/how-kubernetes-creates-runs-containers) \]**
