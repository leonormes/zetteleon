...
## Building a Container Components
...
1. Second Lab: Connect Two Namespaces
...
- A [README.md](http://README.md) with:
   ...
   - What you learned
   - What failed and why
- A [commands.sh](http://commands.sh) with all working commands
- A [troubleshooting.md](http://troubleshooting.md) for issues you hit
