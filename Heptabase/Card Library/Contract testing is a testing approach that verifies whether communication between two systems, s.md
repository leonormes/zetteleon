...
- **Avoid Business Logic**: A good contract test should not be interested in the consumer’s or provider’s internal business logic; that remains the realm of functional tests \[64, 71-75\]. For instance, it verifies the *format* of an array of objects but not the precise *content* of that array \[58, 68\].
