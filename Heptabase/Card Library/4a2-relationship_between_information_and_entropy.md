...
Some more info about [4a3-claude_shannon.md](4a3-claude_shannon.md)

The root note [Information Theory.md](Information%20Theory.md)

In physics entropy is not the same thing as [Shannon's Entropy.md](Shannon's%20Entropy.md).
